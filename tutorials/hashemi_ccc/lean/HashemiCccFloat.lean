...
def hashemiEnv (az : Float) (t : Float) (slack : Float) (omegam : Float) (omegad : Float) (dt : Float) (elSun : Float) (azSun : Float) (dni : Float) (rDrum : Float) (W : Float) (rcm : Float) (Tmax : Float) (rho : Float) (Fdrive : Float) (L10 : Float) (rodLen : Float) (R : Float) (f : Float) (a : Float) (w : Float) (rc : Float) (k : Float) (sigmaslope : Float) (sigmaspec : Float) (hsun : Float) (soil : Float) (alpha : Float) (eps : Float) (Ac : Float) (hC : Float) (Upipe : Float) (UAx : Float) (Coil : Float) (ToilMax : Float) (Toil : Float) (Twall : Float) (Ta : Float) (dr : Array Float) : Array Float :=
  ...
  let v1445 := ((2 : Float) * (3.141592653589793 : Float))
  let v1482 := ((2 : Float) * f)
  let v1483 := ((1 : Float) / R)
  ...
  let v1616 := (Toil - Ta)
  let v1630 := (azSun - v1258)
  #[v1258, v1253, (if v764 then (v762 - v730) else (0 : Float)), (if v1252 then v758 else v766), v711, (if (v763 || v1252) then (1 : Float) else (0 : Float)), (if (feq (if v764 then (v762 - v730) else (0 : Float)) (0 : Float)) then (1 : Float) else (0 : Float)), (if (v1229 <= (Tmax * (((v712 * v1270) - ((0.34 : Float) * v1267)) / (Float.sqrt (((v1267 - v712) ^ 2) + ((v1270 - (0.34 : Float)) ^ 2)))))) then (1 : Float) else (0 : Float)), (((v712 * v752) - ((0.34 : Float) * v749)) / v758), (v760 / (((v712 * v752) - ((0.34 : Float) * v749)) / v758)), ((omegam * (0.05 : Float)) / (Float.sqrt ((((1.84 : Float) / (2 : Float)) ^ 2) + ((0.80 : Float) ^ 2)))), v1328, (v704 - t), (if v1331 then (1 : Float) else (0 : Float)), (if (v1331 && ((0.03 : Float) < v1328)) then (1 : Float) else (0 : Float)), (1.0 / (1.0 + Float.exp (-((elSun - v1330) / (0.01 : Float))))), ((1.0 / (1.0 + Float.exp (-((elSun - v1330) / (0.01 : Float))))) * (1.0 / (1.0 + Float.exp (-((v1328 - (0.03 : Float)) / (0.01 : Float)))))), (v1599 / (64 : Float)), (v1602 / (64 : Float)), (v1593 * (v1599 / (64 : Float))), (((v1593 * (v1599 / (64 : Float))) * dni) * soil), (min ToilMax (Toil + ((dt * ((((alpha * (((v1593 * (v1599 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v1616))) - (Upipe * v1616)) - (max (0 : Float) (UAx * (Toil - Twall))))) / Coil))), (alpha * (((v1593 * (v1599 / (64 : Float))) * dni) * soil)), ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v1616)), (Upipe * v1616), (max (0 : Float) (UAx * (Toil - Twall))), ((((alpha * (((v1593 * (v1599 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v1616))) - (Upipe * v1616)) - (max (0 : Float) (UAx * (Toil - Twall)))), (v1630 - (v1445 * (Float.floor ((v1630 + (3.141592653589793 : Float)) / v1445)))), ((v704 - v1253) - elSun), v1253, (if (feq (if v764 then (v762 - v730) else (0 : Float)) (0 : Float)) then (1 : Float) else (0 : Float)), (if (v1229 <= (Tmax * (((v712 * v1270) - ((0.34 : Float) * v1267)) / (Float.sqrt (((v1267 - v712) ^ 2) + ((v1270 - (0.34 : Float)) ^ 2)))))) then (1 : Float) else (0 : Float)), (((min ToilMax (Toil + ((dt * ((((alpha * (((v1593 * (v1599 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v1616))) - (Upipe * v1616)) - (max (0 : Float) (UAx * (Toil - Twall))))) / Coil))) - (300 : Float)) / (300 : Float)), (1.0 / (1.0 + Float.exp (-((elSun - v1330) / (0.01 : Float))))), ((1.0 / (1.0 + Float.exp (-((elSun - v1330) / (0.01 : Float))))) * (1.0 / (1.0 + Float.exp (-((v1328 - (0.03 : Float)) / (0.01 : Float))))))]
...
def check_hashemiEnv_oil_le (az : Float) (t : Float) (slack : Float) (omegam : Float) (omegad : Float) (dt : Float) (elSun : Float) (azSun : Float) (dni : Float) (rDrum : Float) (W : Float) (rcm : Float) (Tmax : Float) (rho : Float) (Fdrive : Float) (L10 : Float) (rodLen : Float) (R : Float) (f : Float) (a : Float) (w : Float) (rc : Float) (k : Float) (sigmaslope : Float) (sigmaspec : Float) (hsun : Float) (soil : Float) (alpha : Float) (eps : Float) (Ac : Float) (hC : Float) (Upipe : Float) (UAx : Float) (Coil : Float) (ToilMax : Float) (Toil : Float) (Twall : Float) (Ta : Float) (dr : Array Float) : Bool :=
  ...
  let v1599 := ((List.range 64).foldl (fun acc i => acc + (let v1394 := (v1380 + (w * (Float.floor (dr[i * 10 + 0]! * v1377)))); let v1398 := (v1380 + (w * (Float.floor (dr[i * 10 + 1]! * v1377)))); let v1401 := ((dr[i * 10 + 2]! - v1399) * w); let v1403 := ((dr[i * 10 + 3]! - v1399) * w); let v1444 := (hsun * (Float.sqrt dr[i * 10 + 4]!)); let v1446 := (v1445 * dr[i * 10 + 5]!); let v1447 := (Float.cos v1444); let v1449 := (Float.sin v1444); let v1450 := (Float.cos v1446); let v1452 := (Float.sin v1446); let v1456 := ((v1447 * v1404) + (v1449 * ((v1450 * v1431) + (v1452 * ((v1405 * v1433) - (v1406 * v1432)))))); let v1462 := ((v1447 * v1405) + (v1449 * ((v1450 * v1432) + (v1452 * ((v1406 * v1431) - (v1404 * v1433)))))); let v1468 := ((v1447 * v1406) + (v1449 * ((v1450 * v1433) + (v1452 * ((v1404 * v1432) - (v1405 * v1431)))))); let v1479 := (((Float.abs v1394) <= a) && (((Float.abs v1398) <= a) && (((Float.abs v1401) <= v1379) && ((Float.abs v1403) <= v1379)))); let v1480 := (v1394 + v1401); let v1481 := (v1398 + v1403); let v1488 := (Float.sqrt (max ((v1394 ^ 2) + (v1398 ^ 2)) (0.000000000000000001 : Float))); let v1489 := (v1488 ^ 2); let v1495 := ((1 : Float) - ((((1 : Float) + k) * (v1483 ^ 2)) * v1489)); let v1503 := ((v1483 * v1488) / (Float.sqrt (max v1495 (0.000000000000000001 : Float)))); let v1506 := (Float.sqrt ((1 : Float) + (v1503 ^ 2))); let v1507 := (-v1503); let v1510 := (((v1507 * v1394) / v1488) / v1506); let v1513 := (((v1507 * v1398) / v1488) / v1506); let v1514 := ((1 : Float) / v1506); let v1516 := (v1510 + (sigmaslope * dr[i * 10 + 6]!)); let v1518 := (v1513 + (sigmaslope * dr[i * 10 + 7]!)); let v1524 := (Float.sqrt (((v1516 ^ 2) + (v1518 ^ 2)) + (v1514 ^ 2))); let v1525 := (v1516 / v1524); let v1526 := (v1518 / v1524); let v1527 := (v1514 / v1524); let v1541 := (((((v1394 - v1480) * v1510) + ((v1398 - v1481) * v1513)) + ((((v1483 * v1489) / ((1 : Float) + (Float.sqrt (max v1495 (0 : Float))))) - v1482) * v1514)) / (((v1456 * v1510) + (v1462 * v1513)) + (v1468 * v1514))); let v1553 := ((2 : Float) * (((v1456 * v1525) + (v1462 * v1526)) + (v1468 * v1527))); let v1559 := (v1468 - (v1553 * v1527)); let v1561 := ((v1456 - (v1553 * v1525)) + (sigmaspec * dr[i * 10 + 8]!)); let v1563 := ((v1462 - (v1553 * v1526)) + (sigmaspec * dr[i * 10 + 9]!)); let v1569 := (Float.sqrt (((v1561 ^ 2) + (v1563 ^ 2)) + (v1559 ^ 2))); let v1572 := (v1559 / v1569); let v1574 := ((f - (v1482 + (v1541 * v1468))) / v1572); let v1582 := (Float.sqrt ((((v1480 + (v1541 * v1456)) + (v1574 * (v1561 / v1569))) ^ 2) + (((v1481 + (v1541 * v1462)) + (v1574 * (v1563 / v1569))) ^ 2))); let v1584 := ((0 : Float) < v1572); let v1585 := ((v1582 <= rc) && v1584); let v1587 := (if (v1479 && v1585) then (1 : Float) else (0 : Float)); v1587)) 0.0)
  let v1616 := (Toil - Ta)
  let v1629 := (min ToilMax (Toil + ((dt * ((((alpha * (((v1593 * (v1599 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v1616))) - (Upipe * v1616)) - (max (0 : Float) (UAx * (Toil - Twall))))) / Coil)))
  (v1629 <= ToilMax)
...
def hashemiLoop (az : Float) (t : Float) (slack : Float) (dt : Float) (elSun : Float) (azSun : Float) (dni : Float) (rDrum : Float) (W : Float) (rcm : Float) (Tmax : Float) (rho : Float) (Fdrive : Float) (L10 : Float) (rodLen : Float) (R : Float) (f : Float) (a : Float) (w : Float) (rc : Float) (k : Float) (sigmaslope : Float) (sigmaspec : Float) (hsun : Float) (soil : Float) (alpha : Float) (eps : Float) (Ac : Float) (hC : Float) (Upipe : Float) (UAx : Float) (Coil : Float) (ToilMax : Float) (Toil : Float) (Twall : Float) (Ta : Float) (tautPrev : Float) (holdsPrev : Float) (tDead : Float) (b2_0 : Float) (b2_1 : Float) (W1 : Array Float) (b1 : Array Float) (W2 : Array Float) (dr : Array Float) : Array Float :=
  ...
  let v924 := (v876 * v923)
  let v942 := (Float.tanh (((W1[0 * 8 + 0]! * v865) + ((W1[0 * 8 + 1]! * v868) + ((W1[0 * 8 + 2]! * t) + ((W1[0 * 8 + 3]! * tautPrev) + ((W1[0 * 8 + 4]! * holdsPrev) + ((W1[0 * 8 + 5]! * v871) + ((W1[0 * 8 + 6]! * v876) + ((W1[0 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[0]!))
  let v960 := (Float.tanh (((W1[1 * 8 + 0]! * v865) + ((W1[1 * 8 + 1]! * v868) + ((W1[1 * 8 + 2]! * t) + ((W1[1 * 8 + 3]! * tautPrev) + ((W1[1 * 8 + 4]! * holdsPrev) + ((W1[1 * 8 + 5]! * v871) + ((W1[1 * 8 + 6]! * v876) + ((W1[1 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[1]!))
  let v978 := (Float.tanh (((W1[2 * 8 + 0]! * v865) + ((W1[2 * 8 + 1]! * v868) + ((W1[2 * 8 + 2]! * t) + ((W1[2 * 8 + 3]! * tautPrev) + ((W1[2 * 8 + 4]! * holdsPrev) + ((W1[2 * 8 + 5]! * v871) + ((W1[2 * 8 + 6]! * v876) + ((W1[2 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[2]!))
  let v996 := (Float.tanh (((W1[3 * 8 + 0]! * v865) + ((W1[3 * 8 + 1]! * v868) + ((W1[3 * 8 + 2]! * t) + ((W1[3 * 8 + 3]! * tautPrev) + ((W1[3 * 8 + 4]! * holdsPrev) + ((W1[3 * 8 + 5]! * v871) + ((W1[3 * 8 + 6]! * v876) + ((W1[3 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[3]!))
  let v1014 := (Float.tanh (((W1[4 * 8 + 0]! * v865) + ((W1[4 * 8 + 1]! * v868) + ((W1[4 * 8 + 2]! * t) + ((W1[4 * 8 + 3]! * tautPrev) + ((W1[4 * 8 + 4]! * holdsPrev) + ((W1[4 * 8 + 5]! * v871) + ((W1[4 * 8 + 6]! * v876) + ((W1[4 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[4]!))
  let v1032 := (Float.tanh (((W1[5 * 8 + 0]! * v865) + ((W1[5 * 8 + 1]! * v868) + ((W1[5 * 8 + 2]! * t) + ((W1[5 * 8 + 3]! * tautPrev) + ((W1[5 * 8 + 4]! * holdsPrev) + ((W1[5 * 8 + 5]! * v871) + ((W1[5 * 8 + 6]! * v876) + ((W1[5 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[5]!))
  let v1050 := (Float.tanh (((W1[6 * 8 + 0]! * v865) + ((W1[6 * 8 + 1]! * v868) + ((W1[6 * 8 + 2]! * t) + ((W1[6 * 8 + 3]! * tautPrev) + ((W1[6 * 8 + 4]! * holdsPrev) + ((W1[6 * 8 + 5]! * v871) + ((W1[6 * 8 + 6]! * v876) + ((W1[6 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[6]!))
  let v1068 := (Float.tanh (((W1[7 * 8 + 0]! * v865) + ((W1[7 * 8 + 1]! * v868) + ((W1[7 * 8 + 2]! * t) + ((W1[7 * 8 + 3]! * tautPrev) + ((W1[7 * 8 + 4]! * holdsPrev) + ((W1[7 * 8 + 5]! * v871) + ((W1[7 * 8 + 6]! * v876) + ((W1[7 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[7]!))
  let v1086 := (Float.tanh (((W1[8 * 8 + 0]! * v865) + ((W1[8 * 8 + 1]! * v868) + ((W1[8 * 8 + 2]! * t) + ((W1[8 * 8 + 3]! * tautPrev) + ((W1[8 * 8 + 4]! * holdsPrev) + ((W1[8 * 8 + 5]! * v871) + ((W1[8 * 8 + 6]! * v876) + ((W1[8 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[8]!))
  let v1104 := (Float.tanh (((W1[9 * 8 + 0]! * v865) + ((W1[9 * 8 + 1]! * v868) + ((W1[9 * 8 + 2]! * t) + ((W1[9 * 8 + 3]! * tautPrev) + ((W1[9 * 8 + 4]! * holdsPrev) + ((W1[9 * 8 + 5]! * v871) + ((W1[9 * 8 + 6]! * v876) + ((W1[9 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[9]!))
  let v1122 := (Float.tanh (((W1[10 * 8 + 0]! * v865) + ((W1[10 * 8 + 1]! * v868) + ((W1[10 * 8 + 2]! * t) + ((W1[10 * 8 + 3]! * tautPrev) + ((W1[10 * 8 + 4]! * holdsPrev) + ((W1[10 * 8 + 5]! * v871) + ((W1[10 * 8 + 6]! * v876) + ((W1[10 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[10]!))
  let v1140 := (Float.tanh (((W1[11 * 8 + 0]! * v865) + ((W1[11 * 8 + 1]! * v868) + ((W1[11 * 8 + 2]! * t) + ((W1[11 * 8 + 3]! * tautPrev) + ((W1[11 * 8 + 4]! * holdsPrev) + ((W1[11 * 8 + 5]! * v871) + ((W1[11 * 8 + 6]! * v876) + ((W1[11 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[11]!))
  let v1158 := (Float.tanh (((W1[12 * 8 + 0]! * v865) + ((W1[12 * 8 + 1]! * v868) + ((W1[12 * 8 + 2]! * t) + ((W1[12 * 8 + 3]! * tautPrev) + ((W1[12 * 8 + 4]! * holdsPrev) + ((W1[12 * 8 + 5]! * v871) + ((W1[12 * 8 + 6]! * v876) + ((W1[12 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[12]!))
  let v1176 := (Float.tanh (((W1[13 * 8 + 0]! * v865) + ((W1[13 * 8 + 1]! * v868) + ((W1[13 * 8 + 2]! * t) + ((W1[13 * 8 + 3]! * tautPrev) + ((W1[13 * 8 + 4]! * holdsPrev) + ((W1[13 * 8 + 5]! * v871) + ((W1[13 * 8 + 6]! * v876) + ((W1[13 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[13]!))
  let v1194 := (Float.tanh (((W1[14 * 8 + 0]! * v865) + ((W1[14 * 8 + 1]! * v868) + ((W1[14 * 8 + 2]! * t) + ((W1[14 * 8 + 3]! * tautPrev) + ((W1[14 * 8 + 4]! * holdsPrev) + ((W1[14 * 8 + 5]! * v871) + ((W1[14 * 8 + 6]! * v876) + ((W1[14 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[14]!))
  let v1212 := (Float.tanh (((W1[15 * 8 + 0]! * v865) + ((W1[15 * 8 + 1]! * v868) + ((W1[15 * 8 + 2]! * t) + ((W1[15 * 8 + 3]! * tautPrev) + ((W1[15 * 8 + 4]! * holdsPrev) + ((W1[15 * 8 + 5]! * v871) + ((W1[15 * 8 + 6]! * v876) + ((W1[15 * 8 + 7]! * v924) + (0 : Float))))))))) + b1[15]!))
  let v1282 := (-(1.22 : Float))
  let v1285 := (-(0.8 : Float))
  let v1293 := ((1 : Float) - ((2 : Float) - (Float.sqrt (((2 : Float) ^ 2) - ((0.8 : Float) ^ 2)))))
  let v1294 := (-v1293)
  let v1296 := ((v1285 * v882) + (v1294 * v877))
  let v1297 := (-v1285)
  let v1300 := ((v1297 * v877) + (v1294 * v882))
  let v1309 := (Float.sqrt (((v1296 - v1282) ^ 2) + ((v1300 - (0.34 : Float)) ^ 2)))
  let v1310 := (((v1282 * v1300) - ((0.34 : Float) * v1296)) / v1309)
  let v1326 := (Float.sqrt ((((1.84 : Float) / (2 : Float)) ^ 2) + ((0.80 : Float) ^ 2)))
  let v1335 := ((1.22 : Float) * (0.8 : Float))
  let v1336 := ((0.34 : Float) * v1293)
  let v1344 := (if (v1335 <= v1336) then v866 else (Float.atan ((((1.22 : Float) * v1293) + ((0.34 : Float) * (0.8 : Float))) / (v1335 - v1336))))
  let v1345 := (Float.cos (0 : Float))
  let v1347 := (Float.sin (0 : Float))
  let v1358 := (Float.sqrt (((((v1285 * v1345) + (v1294 * v1347)) - v1282) ^ 2) + ((((v1297 * v1347) + (v1294 * v1345)) - (0.34 : Float)) ^ 2)))
  let v1359 := (Float.cos v1344)
  let v1361 := (Float.sin v1344)
  let v1372 := (Float.sqrt (((((v1285 * v1359) + (v1294 * v1361)) - v1282) ^ 2) + ((((v1297 * v1361) + (v1294 * v1359)) - (0.34 : Float)) ^ 2)))
  let v1374 := (((((Float.tanh (((W2[1 * 16 + 0]! * v942) + ((W2[1 * 16 + 1]! * v960) + ((W2[1 * 16 + 2]! * v978) + ((W2[1 * 16 + 3]! * v996) + ((W2[1 * 16 + 4]! * v1014) + ((W2[1 * 16 + 5]! * v1032) + ((W2[1 * 16 + 6]! * v1050) + ((W2[1 * 16 + 7]! * v1068) + ((W2[1 * 16 + 8]! * v1086) + ((W2[1 * 16 + 9]! * v1104) + ((W2[1 * 16 + 10]! * v1122) + ((W2[1 * 16 + 11]! * v1140) + ((W2[1 * 16 + 12]! * v1158) + ((W2[1 * 16 + 13]! * v1176) + ((W2[1 * 16 + 14]! * v1194) + ((W2[1 * 16 + 15]! * v1212) + (0 : Float))))))))))))))))) + b2_1)) * (((0.025 : Float) * (3.141592653589793 : Float)) / (180 : Float))) * v1310) / rDrum) * rDrum)
  let v1376 := ((v1309 + slack) - (v1374 * dt))
  let v1377 := (v1376 < v1372)
  let v1378 := (v1358 < v1376)
  let v1380 := (if v1377 then v1372 else (if v1378 then v1358 else v1376))
  let v1385 := (((0 : Float) + v1344) / (2 : Float))
  let v1386 := (Float.cos v1385)
  let v1388 := (Float.sin v1385)
  let v1400 := (v1380 < (Float.sqrt (((((v1285 * v1386) + (v1294 * v1388)) - v1282) ^ 2) + ((((v1297 * v1388) + (v1294 * v1386)) - (0.34 : Float)) ^ 2))))
  let v1401 := (if v1400 then v1385 else (0 : Float))
  let v1402 := (if v1400 then v1344 else v1385)
  let v1404 := ((v1401 + v1402) / (2 : Float))
  let v1405 := (Float.cos v1404)
  let v1407 := (Float.sin v1404)
  let v1419 := (v1380 < (Float.sqrt (((((v1285 * v1405) + (v1294 * v1407)) - v1282) ^ 2) + ((((v1297 * v1407) + (v1294 * v1405)) - (0.34 : Float)) ^ 2))))
  let v1420 := (if v1419 then v1404 else v1401)
  let v1421 := (if v1419 then v1402 else v1404)
  let v1423 := ((v1420 + v1421) / (2 : Float))
  let v1424 := (Float.cos v1423)
  let v1426 := (Float.sin v1423)
  let v1438 := (v1380 < (Float.sqrt (((((v1285 * v1424) + (v1294 * v1426)) - v1282) ^ 2) + ((((v1297 * v1426) + (v1294 * v1424)) - (0.34 : Float)) ^ 2))))
  let v1439 := (if v1438 then v1423 else v1420)
  let v1440 := (if v1438 then v1421 else v1423)
  let v1442 := ((v1439 + v1440) / (2 : Float))
  let v1443 := (Float.cos v1442)
  let v1445 := (Float.sin v1442)
  let v1457 := (v1380 < (Float.sqrt (((((v1285 * v1443) + (v1294 * v1445)) - v1282) ^ 2) + ((((v1297 * v1445) + (v1294 * v1443)) - (0.34 : Float)) ^ 2))))
  let v1458 := (if v1457 then v1442 else v1439)
  let v1459 := (if v1457 then v1440 else v1442)
  let v1461 := ((v1458 + v1459) / (2 : Float))
  let v1462 := (Float.cos v1461)
  let v1464 := (Float.sin v1461)
  let v1476 := (v1380 < (Float.sqrt (((((v1285 * v1462) + (v1294 * v1464)) - v1282) ^ 2) + ((((v1297 * v1464) + (v1294 * v1462)) - (0.34 : Float)) ^ 2))))
  let v1477 := (if v1476 then v1461 else v1458)
  let v1478 := (if v1476 then v1459 else v1461)
  let v1480 := ((v1477 + v1478) / (2 : Float))
  let v1481 := (Float.cos v1480)
  let v1483 := (Float.sin v1480)
  let v1495 := (v1380 < (Float.sqrt (((((v1285 * v1481) + (v1294 * v1483)) - v1282) ^ 2) + ((((v1297 * v1483) + (v1294 * v1481)) - (0.34 : Float)) ^ 2))))
  let v1496 := (if v1495 then v1480 else v1477)
  let v1497 := (if v1495 then v1478 else v1480)
  let v1499 := ((v1496 + v1497) / (2 : Float))
  let v1500 := (Float.cos v1499)
  let v1502 := (Float.sin v1499)
  let v1514 := (v1380 < (Float.sqrt (((((v1285 * v1500) + (v1294 * v1502)) - v1282) ^ 2) + ((((v1297 * v1502) + (v1294 * v1500)) - (0.34 : Float)) ^ 2))))
  let v1515 := (if v1514 then v1499 else v1496)
  let v1516 := (if v1514 then v1497 else v1499)
  let v1518 := ((v1515 + v1516) / (2 : Float))
  let v1519 := (Float.cos v1518)
  let v1521 := (Float.sin v1518)
  let v1533 := (v1380 < (Float.sqrt (((((v1285 * v1519) + (v1294 * v1521)) - v1282) ^ 2) + ((((v1297 * v1521) + (v1294 * v1519)) - (0.34 : Float)) ^ 2))))
  let v1534 := (if v1533 then v1518 else v1515)
  let v1535 := (if v1533 then v1516 else v1518)
  let v1537 := ((v1534 + v1535) / (2 : Float))
  let v1538 := (Float.cos v1537)
  let v1540 := (Float.sin v1537)
  let v1552 := (v1380 < (Float.sqrt (((((v1285 * v1538) + (v1294 * v1540)) - v1282) ^ 2) + ((((v1297 * v1540) + (v1294 * v1538)) - (0.34 : Float)) ^ 2))))
  let v1553 := (if v1552 then v1537 else v1534)
  let v1554 := (if v1552 then v1535 else v1537)
  let v1556 := ((v1553 + v1554) / (2 : Float))
  let v1557 := (Float.cos v1556)
  let v1559 := (Float.sin v1556)
  let v1571 := (v1380 < (Float.sqrt (((((v1285 * v1557) + (v1294 * v1559)) - v1282) ^ 2) + ((((v1297 * v1559) + (v1294 * v1557)) - (0.34 : Float)) ^ 2))))
  let v1572 := (if v1571 then v1556 else v1553)
  let v1573 := (if v1571 then v1554 else v1556)
  let v1575 := ((v1572 + v1573) / (2 : Float))
  let v1576 := (Float.cos v1575)
  let v1578 := (Float.sin v1575)
  let v1590 := (v1380 < (Float.sqrt (((((v1285 * v1576) + (v1294 * v1578)) - v1282) ^ 2) + ((((v1297 * v1578) + (v1294 * v1576)) - (0.34 : Float)) ^ 2))))
  let v1591 := (if v1590 then v1575 else v1572)
  let v1592 := (if v1590 then v1573 else v1575)
  let v1594 := ((v1591 + v1592) / (2 : Float))
  let v1595 := (Float.cos v1594)
  let v1597 := (Float.sin v1594)
  let v1609 := (v1380 < (Float.sqrt (((((v1285 * v1595) + (v1294 * v1597)) - v1282) ^ 2) + ((((v1297 * v1597) + (v1294 * v1595)) - (0.34 : Float)) ^ 2))))
  let v1610 := (if v1609 then v1594 else v1591)
  let v1611 := (if v1609 then v1592 else v1594)
  let v1613 := ((v1610 + v1611) / (2 : Float))
  let v1614 := (Float.cos v1613)
  let v1616 := (Float.sin v1613)
  let v1628 := (v1380 < (Float.sqrt (((((v1285 * v1614) + (v1294 * v1616)) - v1282) ^ 2) + ((((v1297 * v1616) + (v1294 * v1614)) - (0.34 : Float)) ^ 2))))
  let v1629 := (if v1628 then v1613 else v1610)
  let v1630 := (if v1628 then v1611 else v1613)
  let v1632 := ((v1629 + v1630) / (2 : Float))
  let v1633 := (Float.cos v1632)
  let v1635 := (Float.sin v1632)
  let v1647 := (v1380 < (Float.sqrt (((((v1285 * v1633) + (v1294 * v1635)) - v1282) ^ 2) + ((((v1297 * v1635) + (v1294 * v1633)) - (0.34 : Float)) ^ 2))))
  let v1648 := (if v1647 then v1632 else v1629)
  let v1649 := (if v1647 then v1630 else v1632)
  let v1651 := ((v1648 + v1649) / (2 : Float))
  let v1652 := (Float.cos v1651)
  let v1654 := (Float.sin v1651)
  let v1666 := (v1380 < (Float.sqrt (((((v1285 * v1652) + (v1294 * v1654)) - v1282) ^ 2) + ((((v1297 * v1654) + (v1294 * v1652)) - (0.34 : Float)) ^ 2))))
  let v1667 := (if v1666 then v1651 else v1648)
  let v1668 := (if v1666 then v1649 else v1651)
  let v1670 := ((v1667 + v1668) / (2 : Float))
  let v1671 := (Float.cos v1670)
  let v1673 := (Float.sin v1670)
  let v1685 := (v1380 < (Float.sqrt (((((v1285 * v1671) + (v1294 * v1673)) - v1282) ^ 2) + ((((v1297 * v1673) + (v1294 * v1671)) - (0.34 : Float)) ^ 2))))
  let v1686 := (if v1685 then v1670 else v1667)
  let v1687 := (if v1685 then v1668 else v1670)
  let v1689 := ((v1686 + v1687) / (2 : Float))
  let v1690 := (Float.cos v1689)
  let v1692 := (Float.sin v1689)
  let v1704 := (v1380 < (Float.sqrt (((((v1285 * v1690) + (v1294 * v1692)) - v1282) ^ 2) + ((((v1297 * v1692) + (v1294 * v1690)) - (0.34 : Float)) ^ 2))))
  let v1705 := (if v1704 then v1689 else v1686)
  let v1706 := (if v1704 then v1687 else v1689)
  let v1708 := ((v1705 + v1706) / (2 : Float))
  let v1709 := (Float.cos v1708)
  let v1711 := (Float.sin v1708)
  let v1723 := (v1380 < (Float.sqrt (((((v1285 * v1709) + (v1294 * v1711)) - v1282) ^ 2) + ((((v1297 * v1711) + (v1294 * v1709)) - (0.34 : Float)) ^ 2))))
  let v1724 := (if v1723 then v1708 else v1705)
  let v1725 := (if v1723 then v1706 else v1708)
  let v1727 := ((v1724 + v1725) / (2 : Float))
  let v1728 := (Float.cos v1727)
  let v1730 := (Float.sin v1727)
  let v1742 := (v1380 < (Float.sqrt (((((v1285 * v1728) + (v1294 * v1730)) - v1282) ^ 2) + ((((v1297 * v1730) + (v1294 * v1728)) - (0.34 : Float)) ^ 2))))
  let v1743 := (if v1742 then v1727 else v1724)
  let v1744 := (if v1742 then v1725 else v1727)
  let v1746 := ((v1743 + v1744) / (2 : Float))
  let v1747 := (Float.cos v1746)
  let v1749 := (Float.sin v1746)
  let v1761 := (v1380 < (Float.sqrt (((((v1285 * v1747) + (v1294 * v1749)) - v1282) ^ 2) + ((((v1297 * v1749) + (v1294 * v1747)) - (0.34 : Float)) ^ 2))))
  let v1762 := (if v1761 then v1746 else v1743)
  let v1763 := (if v1761 then v1744 else v1746)
  let v1765 := ((v1762 + v1763) / (2 : Float))
  let v1766 := (Float.cos v1765)
  let v1768 := (Float.sin v1765)
  let v1780 := (v1380 < (Float.sqrt (((((v1285 * v1766) + (v1294 * v1768)) - v1282) ^ 2) + ((((v1297 * v1768) + (v1294 * v1766)) - (0.34 : Float)) ^ 2))))
  let v1781 := (if v1780 then v1765 else v1762)
  let v1782 := (if v1780 then v1763 else v1765)
  let v1784 := ((v1781 + v1782) / (2 : Float))
  let v1785 := (Float.cos v1784)
  let v1787 := (Float.sin v1784)
  let v1799 := (v1380 < (Float.sqrt (((((v1285 * v1785) + (v1294 * v1787)) - v1282) ^ 2) + ((((v1297 * v1787) + (v1294 * v1785)) - (0.34 : Float)) ^ 2))))
  let v1800 := (if v1799 then v1784 else v1781)
  let v1801 := (if v1799 then v1782 else v1784)
  let v1803 := ((v1800 + v1801) / (2 : Float))
  let v1804 := (Float.cos v1803)
  let v1806 := (Float.sin v1803)
  let v1818 := (v1380 < (Float.sqrt (((((v1285 * v1804) + (v1294 * v1806)) - v1282) ^ 2) + ((((v1297 * v1806) + (v1294 * v1804)) - (0.34 : Float)) ^ 2))))
  let v1819 := (if v1818 then v1803 else v1800)
  let v1820 := (if v1818 then v1801 else v1803)
  let v1822 := ((v1819 + v1820) / (2 : Float))
  let v1823 := (Float.cos v1822)
  let v1825 := (Float.sin v1822)
  let v1837 := (v1380 < (Float.sqrt (((((v1285 * v1823) + (v1294 * v1825)) - v1282) ^ 2) + ((((v1297 * v1825) + (v1294 * v1823)) - (0.34 : Float)) ^ 2))))
  let v1842 := (if (v1358 <= v1376) then (0 : Float) else (((if v1837 then v1822 else v1819) + (if v1837 then v1820 else v1822)) / (2 : Float)))
  let v1843 := (W * rcm)
  let v1844 := (Float.cos v1842)
  let v1846 := (Float.sin v1842)
  let v1848 := ((v1285 * v1844) + (v1294 * v1846))
  let v1851 := ((v1297 * v1846) + (v1294 * v1844))
  let v1866 := ((t < v1842) && (!(v1843 <= (Tmax * (((v1282 * v1851) - ((0.34 : Float) * v1848)) / (Float.sqrt (((v1848 - v1282) ^ 2) + ((v1851 - (0.34 : Float)) ^ 2))))))))
  let v1867 := (if v1866 then t else v1842)
  let v1872 := (az + (((((((Float.tanh (((W2[0 * 16 + 0]! * v942) + ((W2[0 * 16 + 1]! * v960) + ((W2[0 * 16 + 2]! * v978) + ((W2[0 * 16 + 3]! * v996) + ((W2[0 * 16 + 4]! * v1014) + ((W2[0 * 16 + 5]! * v1032) + ((W2[0 * 16 + 6]! * v1050) + ((W2[0 * 16 + 7]! * v1068) + ((W2[0 * 16 + 8]! * v1086) + ((W2[0 * 16 + 9]! * v1104) + ((W2[0 * 16 + 10]! * v1122) + ((W2[0 * 16 + 11]! * v1140) + ((W2[0 * 16 + 12]! * v1158) + ((W2[0 * 16 + 13]! * v1176) + ((W2[0 * 16 + 14]! * v1194) + ((W2[0 * 16 + 15]! * v1212) + (0 : Float))))))))))))))))) + b2_0)) * (((0.035 : Float) * (3.141592653589793 : Float)) / (180 : Float))) * v1326) / (0.05 : Float)) * (0.05 : Float)) / v1326) * dt))
  let v1877 := (Float.cos v1867)
  let v1879 := (Float.sin v1867)
  let v1881 := ((v1285 * v1877) + (v1294 * v1879))
  let v1884 := ((v1297 * v1879) + (v1294 * v1877))
  let v1899 := (v866 - v1344)
  let v1900 := (v1899 <= elSun)
  let v1909 := (Float.cos v1872)
  let v1910 := (v1879 * v1909)
  let v1911 := (Float.sin v1872)
  let v1912 := (v1879 * v1911)
  let v1913 := (v1877 * v1909)
  let v1914 := (v1877 * v1911)
  let v1915 := (-v1879)
  let v1940 := ((2 : Float) * a)
  let v1941 := (v1940 / w)
  let v1943 := (w / (2 : Float))
  let v1944 := ((-a) + v1943)
  let v1963 := ((1 : Float) / (2 : Float))
  let v1968 := (-(((((v1914 * v1877) - (v1915 * v1912)) * v885) + (((v1915 * v1910) - (v1913 * v1877)) * v887)) + (((v1913 * v1912) - (v1914 * v1910)) * v888)))
  let v1969 := (-(((v1913 * v885) + (v1914 * v887)) + (v1915 * v888)))
  let v1970 := (-(((v1910 * v885) + (v1912 * v887)) + (v1877 * v888)))
  let v1975 := ((Float.abs v1970) < ((9 : Float) / (10 : Float)))
  let v1976 := (if v1975 then (0 : Float) else (1 : Float))
  let v1977 := (if v1975 then (1 : Float) else (0 : Float))
  let v1980 := ((v1969 * v1977) - (v1970 * (0 : Float)))
  let v1983 := ((v1970 * v1976) - (v1968 * v1977))
  let v1986 := ((v1968 * (0 : Float)) - (v1969 * v1976))
  let v1994 := (Float.sqrt (max (((v1980 ^ 2) + (v1983 ^ 2)) + (v1986 ^ 2)) (0.000000000000000001 : Float)))
  let v1995 := (v1980 / v1994)
  let v1996 := (v1983 / v1994)
  let v1997 := (v1986 / v1994)
  let v2045 := ((2 : Float) * f)
  let v2046 := ((1 : Float) / R)
  let v2156 := ((v1940 ^ 2) * rho)
  let v2162 := ((List.range 64).foldl (fun acc i => acc + (let v1958 := (v1944 + (w * (Float.floor (dr[i * 10 + 0]! * v1941)))); let v1962 := (v1944 + (w * (Float.floor (dr[i * 10 + 1]! * v1941)))); let v1965 := ((dr[i * 10 + 2]! - v1963) * w); let v1967 := ((dr[i * 10 + 3]! - v1963) * w); let v2008 := (hsun * (Float.sqrt dr[i * 10 + 4]!)); let v2009 := (v860 * dr[i * 10 + 5]!); let v2010 := (Float.cos v2008); let v2012 := (Float.sin v2008); let v2013 := (Float.cos v2009); let v2015 := (Float.sin v2009); let v2019 := ((v2010 * v1968) + (v2012 * ((v2013 * v1995) + (v2015 * ((v1969 * v1997) - (v1970 * v1996)))))); let v2025 := ((v2010 * v1969) + (v2012 * ((v2013 * v1996) + (v2015 * ((v1970 * v1995) - (v1968 * v1997)))))); let v2031 := ((v2010 * v1970) + (v2012 * ((v2013 * v1997) + (v2015 * ((v1968 * v1996) - (v1969 * v1995)))))); let v2042 := (((Float.abs v1958) <= a) && (((Float.abs v1962) <= a) && (((Float.abs v1965) <= v1943) && ((Float.abs v1967) <= v1943)))); let v2043 := (v1958 + v1965); let v2044 := (v1962 + v1967); let v2051 := (Float.sqrt (max ((v1958 ^ 2) + (v1962 ^ 2)) (0.000000000000000001 : Float))); let v2052 := (v2051 ^ 2); let v2058 := ((1 : Float) - ((((1 : Float) + k) * (v2046 ^ 2)) * v2052)); let v2066 := ((v2046 * v2051) / (Float.sqrt (max v2058 (0.000000000000000001 : Float)))); let v2069 := (Float.sqrt ((1 : Float) + (v2066 ^ 2))); let v2070 := (-v2066); let v2073 := (((v2070 * v1958) / v2051) / v2069); let v2076 := (((v2070 * v1962) / v2051) / v2069); let v2077 := ((1 : Float) / v2069); let v2079 := (v2073 + (sigmaslope * dr[i * 10 + 6]!)); let v2081 := (v2076 + (sigmaslope * dr[i * 10 + 7]!)); let v2087 := (Float.sqrt (((v2079 ^ 2) + (v2081 ^ 2)) + (v2077 ^ 2))); let v2088 := (v2079 / v2087); let v2089 := (v2081 / v2087); let v2090 := (v2077 / v2087); let v2104 := (((((v1958 - v2043) * v2073) + ((v1962 - v2044) * v2076)) + ((((v2046 * v2052) / ((1 : Float) + (Float.sqrt (max v2058 (0 : Float))))) - v2045) * v2077)) / (((v2019 * v2073) + (v2025 * v2076)) + (v2031 * v2077))); let v2116 := ((2 : Float) * (((v2019 * v2088) + (v2025 * v2089)) + (v2031 * v2090))); let v2122 := (v2031 - (v2116 * v2090)); let v2124 := ((v2019 - (v2116 * v2088)) + (sigmaspec * dr[i * 10 + 8]!)); let v2126 := ((v2025 - (v2116 * v2089)) + (sigmaspec * dr[i * 10 + 9]!)); let v2132 := (Float.sqrt (((v2124 ^ 2) + (v2126 ^ 2)) + (v2122 ^ 2))); let v2135 := (v2122 / v2132); let v2137 := ((f - (v2045 + (v2104 * v2031))) / v2135); let v2145 := (Float.sqrt ((((v2043 + (v2104 * v2019)) + (v2137 * (v2124 / v2132))) ^ 2) + (((v2044 + (v2104 * v2025)) + (v2137 * (v2126 / v2132))) ^ 2))); let v2147 := ((0 : Float) < v2135); let v2148 := ((v2145 <= rc) && v2147); let v2150 := (if (v2042 && v2148) then (1 : Float) else (0 : Float)); v2150)) 0.0)
  let v2165 := ((List.range 64).foldl (fun acc i => acc + (let v1958 := (v1944 + (w * (Float.floor (dr[i * 10 + 0]! * v1941)))); let v1962 := (v1944 + (w * (Float.floor (dr[i * 10 + 1]! * v1941)))); let v1965 := ((dr[i * 10 + 2]! - v1963) * w); let v1967 := ((dr[i * 10 + 3]! - v1963) * w); let v2008 := (hsun * (Float.sqrt dr[i * 10 + 4]!)); let v2009 := (v860 * dr[i * 10 + 5]!); let v2010 := (Float.cos v2008); let v2012 := (Float.sin v2008); let v2013 := (Float.cos v2009); let v2015 := (Float.sin v2009); let v2019 := ((v2010 * v1968) + (v2012 * ((v2013 * v1995) + (v2015 * ((v1969 * v1997) - (v1970 * v1996)))))); let v2025 := ((v2010 * v1969) + (v2012 * ((v2013 * v1996) + (v2015 * ((v1970 * v1995) - (v1968 * v1997)))))); let v2031 := ((v2010 * v1970) + (v2012 * ((v2013 * v1997) + (v2015 * ((v1968 * v1996) - (v1969 * v1995)))))); let v2042 := (((Float.abs v1958) <= a) && (((Float.abs v1962) <= a) && (((Float.abs v1965) <= v1943) && ((Float.abs v1967) <= v1943)))); let v2043 := (v1958 + v1965); let v2044 := (v1962 + v1967); let v2051 := (Float.sqrt (max ((v1958 ^ 2) + (v1962 ^ 2)) (0.000000000000000001 : Float))); let v2052 := (v2051 ^ 2); let v2058 := ((1 : Float) - ((((1 : Float) + k) * (v2046 ^ 2)) * v2052)); let v2066 := ((v2046 * v2051) / (Float.sqrt (max v2058 (0.000000000000000001 : Float)))); let v2069 := (Float.sqrt ((1 : Float) + (v2066 ^ 2))); let v2070 := (-v2066); let v2073 := (((v2070 * v1958) / v2051) / v2069); let v2076 := (((v2070 * v1962) / v2051) / v2069); let v2077 := ((1 : Float) / v2069); let v2079 := (v2073 + (sigmaslope * dr[i * 10 + 6]!)); let v2081 := (v2076 + (sigmaslope * dr[i * 10 + 7]!)); let v2087 := (Float.sqrt (((v2079 ^ 2) + (v2081 ^ 2)) + (v2077 ^ 2))); let v2088 := (v2079 / v2087); let v2089 := (v2081 / v2087); let v2090 := (v2077 / v2087); let v2104 := (((((v1958 - v2043) * v2073) + ((v1962 - v2044) * v2076)) + ((((v2046 * v2052) / ((1 : Float) + (Float.sqrt (max v2058 (0 : Float))))) - v2045) * v2077)) / (((v2019 * v2073) + (v2025 * v2076)) + (v2031 * v2077))); let v2116 := ((2 : Float) * (((v2019 * v2088) + (v2025 * v2089)) + (v2031 * v2090))); let v2122 := (v2031 - (v2116 * v2090)); let v2124 := ((v2019 - (v2116 * v2088)) + (sigmaspec * dr[i * 10 + 8]!)); let v2126 := ((v2025 - (v2116 * v2089)) + (sigmaspec * dr[i * 10 + 9]!)); let v2132 := (Float.sqrt (((v2124 ^ 2) + (v2126 ^ 2)) + (v2122 ^ 2))); let v2135 := (v2122 / v2132); let v2137 := ((f - (v2045 + (v2104 * v2031))) / v2135); let v2145 := (Float.sqrt ((((v2043 + (v2104 * v2019)) + (v2137 * (v2124 / v2132))) ^ 2) + (((v2044 + (v2104 * v2025)) + (v2137 * (v2126 / v2132))) ^ 2))); let v2147 := ((0 : Float) < v2135); let v2148 := ((v2145 <= rc) && v2147); let v2150 := (if (v2042 && v2148) then (1 : Float) else (0 : Float)); (1.0 / (1.0 + Float.exp (-((rc - v2145) / (0.005 : Float))))))) 0.0)
  let v2179 := (Toil - Ta)
  let v2193 := (azSun - v1872)
  #[v1872, v1867, (if v1378 then (v1376 - v1358) else (0 : Float)), (if v1866 then v1309 else v1380), v1344, (if (v1377 || v1866) then (1 : Float) else (0 : Float)), (if (feq (if v1378 then (v1376 - v1358) else (0 : Float)) (0 : Float)) then (1 : Float) else (0 : Float)), (if (v1843 <= (Tmax * (((v1282 * v1884) - ((0.34 : Float) * v1881)) / (Float.sqrt (((v1881 - v1282) ^ 2) + ((v1884 - (0.34 : Float)) ^ 2)))))) then (1 : Float) else (0 : Float)), v1310, (v1374 / v1310), ((((((Float.tanh (((W2[0 * 16 + 0]! * v942) + ((W2[0 * 16 + 1]! * v960) + ((W2[0 * 16 + 2]! * v978) + ((W2[0 * 16 + 3]! * v996) + ((W2[0 * 16 + 4]! * v1014) + ((W2[0 * 16 + 5]! * v1032) + ((W2[0 * 16 + 6]! * v1050) + ((W2[0 * 16 + 7]! * v1068) + ((W2[0 * 16 + 8]! * v1086) + ((W2[0 * 16 + 9]! * v1104) + ((W2[0 * 16 + 10]! * v1122) + ((W2[0 * 16 + 11]! * v1140) + ((W2[0 * 16 + 12]! * v1158) + ((W2[0 * 16 + 13]! * v1176) + ((W2[0 * 16 + 14]! * v1194) + ((W2[0 * 16 + 15]! * v1212) + (0 : Float))))))))))))))))) + b2_0)) * (((0.035 : Float) * (3.141592653589793 : Float)) / (180 : Float))) * v1326) / (0.05 : Float)) * (0.05 : Float)) / v1326), v919, (v866 - t), (if v1900 then (1 : Float) else (0 : Float)), (if (v1900 && ((0.03 : Float) < v919)) then (1 : Float) else (0 : Float)), (1.0 / (1.0 + Float.exp (-((elSun - v1899) / (0.01 : Float))))), ((1.0 / (1.0 + Float.exp (-((elSun - v1899) / (0.01 : Float))))) * v923), (v2162 / (64 : Float)), (v2165 / (64 : Float)), (v2156 * (v2162 / (64 : Float))), (((v2156 * (v2162 / (64 : Float))) * dni) * soil), (min ToilMax (Toil + ((dt * ((((alpha * (((v2156 * (v2162 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v2179))) - (Upipe * v2179)) - (max (0 : Float) (UAx * (Toil - Twall))))) / Coil))), (alpha * (((v2156 * (v2162 / (64 : Float))) * dni) * soil)), ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v2179)), (Upipe * v2179), (max (0 : Float) (UAx * (Toil - Twall))), ((((alpha * (((v2156 * (v2162 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v2179))) - (Upipe * v2179)) - (max (0 : Float) (UAx * (Toil - Twall)))), (v2193 - (v860 * (Float.floor ((v2193 + (3.141592653589793 : Float)) / v860)))), ((v866 - v1867) - elSun), v1867, (if (feq (if v1378 then (v1376 - v1358) else (0 : Float)) (0 : Float)) then (1 : Float) else (0 : Float)), (if (v1843 <= (Tmax * (((v1282 * v1884) - ((0.34 : Float) * v1881)) / (Float.sqrt (((v1881 - v1282) ^ 2) + ((v1884 - (0.34 : Float)) ^ 2)))))) then (1 : Float) else (0 : Float)), (((min ToilMax (Toil + ((dt * ((((alpha * (((v2156 * (v2162 / (64 : Float))) * dni) * soil)) - ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * v2179))) - (Upipe * v2179)) - (max (0 : Float) (UAx * (Toil - Twall))))) / Coil))) - (300 : Float)) / (300 : Float)), (1.0 / (1.0 + Float.exp (-((elSun - v1899) / (0.01 : Float))))), ((1.0 / (1.0 + Float.exp (-((elSun - v1899) / (0.01 : Float))))) * v923), v865, v868, t, tautPrev, holdsPrev, v871, v876, v924, (Float.tanh (((W2[0 * 16 + 0]! * v942) + ((W2[0 * 16 + 1]! * v960) + ((W2[0 * 16 + 2]! * v978) + ((W2[0 * 16 + 3]! * v996) + ((W2[0 * 16 + 4]! * v1014) + ((W2[0 * 16 + 5]! * v1032) + ((W2[0 * 16 + 6]! * v1050) + ((W2[0 * 16 + 7]! * v1068) + ((W2[0 * 16 + 8]! * v1086) + ((W2[0 * 16 + 9]! * v1104) + ((W2[0 * 16 + 10]! * v1122) + ((W2[0 * 16 + 11]! * v1140) + ((W2[0 * 16 + 12]! * v1158) + ((W2[0 * 16 + 13]! * v1176) + ((W2[0 * 16 + 14]! * v1194) + ((W2[0 * 16 + 15]! * v1212) + (0 : Float))))))))))))))))) + b2_0)), (Float.tanh (((W2[1 * 16 + 0]! * v942) + ((W2[1 * 16 + 1]! * v960) + ((W2[1 * 16 + 2]! * v978) + ((W2[1 * 16 + 3]! * v996) + ((W2[1 * 16 + 4]! * v1014) + ((W2[1 * 16 + 5]! * v1032) + ((W2[1 * 16 + 6]! * v1050) + ((W2[1 * 16 + 7]! * v1068) + ((W2[1 * 16 + 8]! * v1086) + ((W2[1 * 16 + 9]! * v1104) + ((W2[1 * 16 + 10]! * v1122) + ((W2[1 * 16 + 11]! * v1140) + ((W2[1 * 16 + 12]! * v1158) + ((W2[1 * 16 + 13]! * v1176) + ((W2[1 * 16 + 14]! * v1194) + ((W2[1 * 16 + 15]! * v1212) + (0 : Float))))))))))))))))) + b2_1))]
...
#eval IO.println ("obsOf " ++ toString ((obsOf 0.757131 0.698582 0.640033 0.581484 0.522936 0.464387 0.405838 0.347289).map Float.toBits))
#eval IO.println ("obsOf " ++ toString ((obsOf 0.425939 0.367390 0.308841 0.250292 1.791744 1.733195 1.674646 1.616097).map Float.toBits))
#eval IO.println ("obsOf " ++ toString ((obsOf 1.694747 1.636198 1.577649 1.519100 1.460552 1.402003 1.343454 1.284905).map Float.toBits))
...
#eval IO.println ("oilStep " ++ toString (oilStep 0.570979 0.512430 0.453881 0.395332 0.336784 0.278235 0.219686 1.761137 1.702588 1.644040 1.585491 1.526942 1.468393).toBits)
#eval IO.println ("oilStep " ++ toString (oilStep 0.239787 1.781238 1.722689 1.664140 1.605592 1.547043 1.488494 1.429945 1.371396 1.312848 1.254299 1.195750 1.137201).toBits)
#eval IO.println ("oilStep " ++ toString (oilStep 1.508595 1.450046 1.391497 1.332948 1.274400 1.215851 1.157302 1.098753 1.040204 0.981656 0.923107 0.864558 0.806009).toBits)
...
#eval IO.println ("check_oilStep_lipschitz " ++ toString (check_oilStep_lipschitz 0.384827 0.326278 0.267729 0.209180 1.750632 1.692083 1.633534 1.574985 1.516436 1.457888 1.399339 1.340790 1.282241 1.223692 1.165144))
#eval IO.println ("check_oilStep_lipschitz " ++ toString (check_oilStep_lipschitz 1.653635 1.595086 1.536537 1.477988 1.419440 1.360891 1.302342 1.243793 1.185244 1.126696 1.068147 1.009598 0.951049 0.892500 0.833952))
#eval IO.println ("check_oilStep_lipschitz " ++ toString (check_oilStep_lipschitz 1.322443 1.263894 1.205345 1.146796 1.088248 1.029699 0.971150 0.912601 0.854052 0.795504 0.736955 0.678406 0.619857 0.561308 0.502760))
...
#eval IO.println ("check_play_budget " ++ toString (check_play_budget 1.426371 1.367822 1.309273 1.250724))
#eval IO.println ("check_play_budget " ++ toString (check_play_budget 1.095179 1.036630 0.978081 0.919532))
#eval IO.println ("check_play_budget " ++ toString (check_play_budget 0.763987 0.705438 0.646889 0.588340))

def check_plumbed_shift (eps : Float) : Bool :=
  (!((0 : Float) <= eps) || (!(eps <= (0.0005 : Float)) || (((1.30 : Float) * (Float.sin eps)) <= (0.00065 : Float))))

#eval IO.println ("check_plumbed_shift " ++ toString (check_plumbed_shift 1.240219))
#eval IO.println ("check_plumbed_shift " ++ toString (check_plumbed_shift 0.909027))
#eval IO.println ("check_plumbed_shift " ++ toString (check_plumbed_shift 0.577835))
...
#eval IO.println ("pointVel " ++ toString ((pointVel 1.054067 0.995518 0.936969 0.878420 0.819872 0.761323 0.702774 0.644225 0.585676).map Float.toBits))
#eval IO.println ("pointVel " ++ toString ((pointVel 0.722875 0.664326 0.605777 0.547228 0.488680 0.430131 0.371582 0.313033 0.254484).map Float.toBits))
#eval IO.println ("pointVel " ++ toString ((pointVel 0.391683 0.333134 0.274585 0.216036 1.757488 1.698939 1.640390 1.581841 1.523292).map Float.toBits))
...
#eval IO.println ("pointingError " ++ toString (pointingError 0.867915 0.809366 0.750817 0.692268).toBits)
#eval IO.println ("pointingError " ++ toString (pointingError 0.536723 0.478174 0.419625 0.361076).toBits)
#eval IO.println ("pointingError " ++ toString (pointingError 0.205531 1.746982 1.688433 1.629884).toBits)
...
#eval IO.println ("postTop " ++ toString ((postTop 0.681763 0.623214 0.564665 0.506116 0.447568 0.389019 0.330470 0.271921 0.213372 1.754824 1.696275 1.637726 1.579177).map Float.toBits))
#eval IO.println ("postTop " ++ toString ((postTop 0.350571 0.292022 0.233473 1.774924 1.716376 1.657827 1.599278 1.540729 1.482180 1.423632 1.365083 1.306534 1.247985).map Float.toBits))
#eval IO.println ("postTop " ++ toString ((postTop 1.619379 1.560830 1.502281 1.443732 1.385184 1.326635 1.268086 1.209537 1.150988 1.092440 1.033891 0.975342 0.916793).map Float.toBits))
...
#eval IO.println ("check_postTop_on_rail " ++ toString (check_postTop_on_rail 0.495611 0.437062 0.378513 0.319964 0.261416 0.202867 1.744318 1.685769 1.627220 1.568672 1.510123 1.451574))
#eval IO.println ("check_postTop_on_rail " ++ toString (check_postTop_on_rail 1.764419 1.705870 1.647321 1.588772 1.530224 1.471675 1.413126 1.354577 1.296028 1.237480 1.178931 1.120382))
#eval IO.println ("check_postTop_on_rail " ++ toString (check_postTop_on_rail 1.433227 1.374678 1.316129 1.257580 1.199032 1.140483 1.081934 1.023385 0.964836 0.906288 0.847739 0.789190))
...
#eval IO.println ("check_postTops_apart " ++ toString (check_postTops_apart 0.309459 0.250910 1.792361 1.733812 1.675264 1.616715 1.558166 1.499617 1.441068 1.382520 1.323971 1.265422))
#eval IO.println ("check_postTops_apart " ++ toString (check_postTops_apart 1.578267 1.519718 1.461169 1.402620 1.344072 1.285523 1.226974 1.168425 1.109876 1.051328 0.992779 0.934230))
#eval IO.println ("check_postTops_apart " ++ toString (check_postTops_apart 1.247075 1.188526 1.129977 1.071428 1.012880 0.954331 0.895782 0.837233 0.778684 0.720136 0.661587 0.603038))
...
#eval IO.println ("check_postTops_level " ++ toString (check_postTops_level 1.723307 1.664758 1.606209 1.547660 1.489112 1.430563 1.372014 1.313465 1.254916 1.196368 1.137819 1.079270))
#eval IO.println ("check_postTops_level " ++ toString (check_postTops_level 1.392115 1.333566 1.275017 1.216468 1.157920 1.099371 1.040822 0.982273 0.923724 0.865176 0.806627 0.748078))
#eval IO.println ("check_postTops_level " ++ toString (check_postTops_level 1.060923 1.002374 0.943825 0.885276 0.826728 0.768179 0.709630 0.651081 0.592532 0.533984 0.475435 0.416886))
...
#eval IO.println ("check_postTops_offAxis " ++ toString (check_postTops_offAxis 1.537155 1.478606 1.420057 1.361508 1.302960 1.244411 1.185862 1.127313 1.068764 1.010216 0.951667 0.893118 0.834569))
#eval IO.println ("check_postTops_offAxis " ++ toString (check_postTops_offAxis 1.205963 1.147414 1.088865 1.030316 0.971768 0.913219 0.854670 0.796121 0.737572 0.679024 0.620475 0.561926 0.503377))
#eval IO.println ("check_postTops_offAxis " ++ toString (check_postTops_offAxis 0.874771 0.816222 0.757673 0.699124 0.640576 0.582027 0.523478 0.464929 0.406380 0.347832 0.289283 0.230734 1.772185))
...
#eval IO.println ("check_pow4_lipschitz " ++ toString (check_pow4_lipschitz 1.351003 1.292454 1.233905))
#eval IO.println ("check_pow4_lipschitz " ++ toString (check_pow4_lipschitz 1.019811 0.961262 0.902713))
#eval IO.println ("check_pow4_lipschitz " ++ toString (check_pow4_lipschitz 0.688619 0.630070 0.571521))
...
#eval IO.println ("prop_azRate_pos " ++ toString (prop_azRate_pos 1.461787 1.403238 1.344689))
#eval IO.println ("prop_azRate_pos " ++ toString (prop_azRate_pos 1.130595 1.072046 1.013497))
#eval IO.println ("prop_azRate_pos " ++ toString (prop_azRate_pos 0.799403 0.740854 0.682305))

def prop_bearing_life (L10 : Float) : Bool :=
  (!(((10 : Float) ^ 6) <= L10) || (((100 : Float) * ((20 : Float) * (365.25 : Float))) < L10))

#eval IO.println ("prop_bearing_life " ++ toString (prop_bearing_life 1.275635))
#eval IO.println ("prop_bearing_life " ++ toString (prop_bearing_life 0.944443))
#eval IO.println ("prop_bearing_life " ++ toString (prop_bearing_life 0.613251))
...
#eval IO.println ("prop_cable_drop_small " ++ toString (prop_cable_drop_small 0.531027 0.472478))
#eval IO.println ("prop_cable_drop_small " ++ toString (prop_cable_drop_small 1.799835 1.741286))
#eval IO.println ("prop_cable_drop_small " ++ toString (prop_cable_drop_small 1.468643 1.410094))

def prop_captureS_slope (rc : Float) (r1 : Float) (r2 : Float) : Bool :=
  ((Float.abs ((1.0 / (1.0 + Float.exp (-((rc - r1) / (0.005 : Float))))) - (1.0 / (1.0 + Float.exp (-((rc - r2) / (0.005 : Float))))))) <= ((Float.abs (r1 - r2)) / ((4 : Float) * (0.005 : Float))))

#eval IO.println ("prop_captureS_slope " ++ toString (prop_captureS_slope 0.344875 0.286326 0.227777))
#eval IO.println ("prop_captureS_slope " ++ toString (prop_captureS_slope 1.613683 1.555134 1.496585))
#eval IO.println ("prop_captureS_slope " ++ toString (prop_captureS_slope 1.282491 1.223942 1.165393))
...
#eval IO.println ("prop_clearance_hashemi " ++ toString (prop_clearance_hashemi 1.758723))
#eval IO.println ("prop_clearance_hashemi " ++ toString (prop_clearance_hashemi 1.427531))
#eval IO.println ("prop_clearance_hashemi " ++ toString (prop_clearance_hashemi 1.096339))
...
#eval IO.println ("prop_conicZ_paraboloid " ++ toString (prop_conicZ_paraboloid 1.572571 1.514022))
#eval IO.println ("prop_conicZ_paraboloid " ++ toString (prop_conicZ_paraboloid 1.241379 1.182830))
#eval IO.println ("prop_conicZ_paraboloid " ++ toString (prop_conicZ_paraboloid 0.910187 0.851638))
...
#eval IO.println ("prop_conicZ_sphere " ++ toString (prop_conicZ_sphere 1.386419 1.327870))
#eval IO.println ("prop_conicZ_sphere " ++ toString (prop_conicZ_sphere 1.055227 0.996678))
#eval IO.println ("prop_conicZ_sphere " ++ toString (prop_conicZ_sphere 0.724035 0.665486))
...
#eval IO.println ("prop_constraints_reciprocal_yaw " ++ toString (prop_constraints_reciprocal_yaw 1.200267 1.141718 1.083169 1.024620 0.966072 0.907523 0.848974 0.790425 0.731876 0.673328 0.614779 0.556230))
#eval IO.println ("prop_constraints_reciprocal_yaw " ++ toString (prop_constraints_reciprocal_yaw 0.869075 0.810526 0.751977 0.693428 0.634880 0.576331 0.517782 0.459233 0.400684 0.342136 0.283587 0.225038))
#eval IO.println ("prop_constraints_reciprocal_yaw " ++ toString (prop_constraints_reciprocal_yaw 0.537883 0.479334 0.420785 0.362236 0.303688 0.245139 1.786590 1.728041 1.669492 1.610944 1.552395 1.493846))
...
#eval IO.println ("prop_dishAxes_rot " ++ toString (prop_dishAxes_rot 0.455659 0.397110 0.338561))
#eval IO.println ("prop_dishAxes_rot " ++ toString (prop_dishAxes_rot 1.724467 1.665918 1.607369))
#eval IO.println ("prop_dishAxes_rot " ++ toString (prop_dishAxes_rot 1.393275 1.334726 1.276177))
...
#eval IO.println ("prop_drive_recip_yaw " ++ toString (prop_drive_recip_yaw 1.497203 1.438654 1.380105 1.321556 1.263008 1.204459 1.145910 1.087361 1.028812 0.970264 0.911715 0.853166 0.794617))
#eval IO.println ("prop_drive_recip_yaw " ++ toString (prop_drive_recip_yaw 1.166011 1.107462 1.048913 0.990364 0.931816 0.873267 0.814718 0.756169 0.697620 0.639072 0.580523 0.521974 0.463425))
#eval IO.println ("prop_drive_recip_yaw " ++ toString (prop_drive_recip_yaw 0.834819 0.776270 0.717721 0.659172 0.600624 0.542075 0.483526 0.424977 0.366428 0.307880 0.249331 1.790782 1.732233))
...
#eval IO.println ("prop_drive_works_on_yaw " ++ toString (prop_drive_works_on_yaw 1.311051 1.252502 1.193953 1.135404 1.076856 1.018307 0.959758 0.901209 0.842660 0.784112 0.725563 0.667014 0.608465))
#eval IO.println ("prop_drive_works_on_yaw " ++ toString (prop_drive_works_on_yaw 0.979859 0.921310 0.862761 0.804212 0.745664 0.687115 0.628566 0.570017 0.511468 0.452920 0.394371 0.335822 0.277273))
#eval IO.println ("prop_drive_works_on_yaw " ++ toString (prop_drive_works_on_yaw 0.648667 0.590118 0.531569 0.473020 0.414472 0.355923 0.297374 0.238825 1.780276 1.721728 1.663179 1.604630 1.546081))
...
#eval IO.println ("prop_edgeClip_cross " ++ toString (prop_edgeClip_cross 1.124899 1.066350 1.007801 0.949252 0.890704))
#eval IO.println ("prop_edgeClip_cross " ++ toString (prop_edgeClip_cross 0.793707 0.735158 0.676609 0.618060 0.559512))
#eval IO.println ("prop_edgeClip_cross " ++ toString (prop_edgeClip_cross 0.462515 0.403966 0.345417 0.286868 0.228320))
...
#eval IO.println ("prop_edgeClip_radius " ++ toString (prop_edgeClip_radius 0.938747 0.880198 0.821649))
#eval IO.println ("prop_edgeClip_radius " ++ toString (prop_edgeClip_radius 0.607555 0.549006 0.490457))
#eval IO.println ("prop_edgeClip_radius " ++ toString (prop_edgeClip_radius 0.276363 0.217814 1.759265))
...
#eval IO.println ("prop_edgeClip_radius_hashemi " ++ toString (prop_edgeClip_radius_hashemi 0.752595))
#eval IO.println ("prop_edgeClip_radius_hashemi " ++ toString (prop_edgeClip_radius_hashemi 0.421403))
#eval IO.println ("prop_edgeClip_radius_hashemi " ++ toString (prop_edgeClip_radius_hashemi 1.690211))

def prop_edgeClip_reach (a : Float) (ze : Float) (t : Float) : Bool :=
  ((Float.abs (((-a) * (Float.cos t)) + ((-ze) * (Float.sin t)))) <= (Float.sqrt ((a ^ 2) + (ze ^ 2))))

#eval IO.println ("prop_edgeClip_reach " ++ toString (prop_edgeClip_reach 0.566443 0.507894 0.449345))
#eval IO.println ("prop_edgeClip_reach " ++ toString (prop_edgeClip_reach 0.235251 1.776702 1.718153))
#eval IO.println ("prop_edgeClip_reach " ++ toString (prop_edgeClip_reach 1.504059 1.445510 1.386961))

def prop_edgeDepth_horizon (f : Float) (a : Float) (sag : Float) : Bool :=
  (feq (((f - sag) * (Float.sin (0 : Float))) + (a * (Float.cos (0 : Float)))) a)

#eval IO.println ("prop_edgeDepth_horizon " ++ toString (prop_edgeDepth_horizon 0.380291 0.321742 0.263193))
#eval IO.println ("prop_edgeDepth_horizon " ++ toString (prop_edgeDepth_horizon 1.649099 1.590550 1.532001))
#eval IO.println ("prop_edgeDepth_horizon " ++ toString (prop_edgeDepth_horizon 1.317907 1.259358 1.200809))

def prop_edgeDepth_le (f : Float) (a : Float) (sag : Float) (el : Float) : Bool :=
  let v4 := (f - sag)
  (((v4 * (Float.sin el)) + (a * (Float.cos el))) <= (Float.sqrt ((v4 ^ 2) + (a ^ 2))))

#eval IO.println ("prop_edgeDepth_le " ++ toString (prop_edgeDepth_le 1.794139 1.735590 1.677041 1.618492))
#eval IO.println ("prop_edgeDepth_le " ++ toString (prop_edgeDepth_le 1.462947 1.404398 1.345849 1.287300))
#eval IO.println ("prop_edgeDepth_le " ++ toString (prop_edgeDepth_le 1.131755 1.073206 1.014657 0.956108))
...
#eval IO.println ("prop_edgeDepth_noon " ++ toString (prop_edgeDepth_noon 1.607987 1.549438 1.490889))
#eval IO.println ("prop_edgeDepth_noon " ++ toString (prop_edgeDepth_noon 1.276795 1.218246 1.159697))
#eval IO.println ("prop_edgeDepth_noon " ++ toString (prop_edgeDepth_noon 0.945603 0.887054 0.828505))
...
#eval IO.println ("prop_edgeLever_dead " ++ toString (prop_edgeLever_dead 1.421835 1.363286 1.304737 1.246188 1.187640))
#eval IO.println ("prop_edgeLever_dead " ++ toString (prop_edgeLever_dead 1.090643 1.032094 0.973545 0.914996 0.856448))
#eval IO.println ("prop_edgeLever_dead " ++ toString (prop_edgeLever_dead 0.759451 0.700902 0.642353 0.583804 0.525256))
...
#eval IO.println ("prop_edgeLever_pos_iff " ++ toString (prop_edgeLever_pos_iff 1.235683 1.177134 1.118585 1.060036 1.001488))
#eval IO.println ("prop_edgeLever_pos_iff " ++ toString (prop_edgeLever_pos_iff 0.904491 0.845942 0.787393 0.728844 0.670296))
#eval IO.println ("prop_edgeLever_pos_iff " ++ toString (prop_edgeLever_pos_iff 0.573299 0.514750 0.456201 0.397652 0.339104))
...
#eval IO.println ("prop_elPower_eq_wire " ++ toString (prop_elPower_eq_wire 1.049531 0.990982 0.932433 0.873884 0.815336))
#eval IO.println ("prop_elPower_eq_wire " ++ toString (prop_elPower_eq_wire 0.718339 0.659790 0.601241 0.542692 0.484144))
#eval IO.println ("prop_elPower_eq_wire " ++ toString (prop_elPower_eq_wire 0.387147 0.328598 0.270049 0.211500 1.752952))
...
#eval IO.println ("prop_elPower_le " ++ toString (prop_elPower_le 0.863379 0.804830 0.746281 0.687732))
#eval IO.println ("prop_elPower_le " ++ toString (prop_elPower_le 0.532187 0.473638 0.415089 0.356540))
#eval IO.println ("prop_elPower_le " ++ toString (prop_elPower_le 0.200995 1.742446 1.683897 1.625348))
...
#eval IO.println ("prop_focus_on_axis " ++ toString (prop_focus_on_axis 0.491075 0.432526 0.373977))
#eval IO.println ("prop_focus_on_axis " ++ toString (prop_focus_on_axis 1.759883 1.701334 1.642785))
#eval IO.println ("prop_focus_on_axis " ++ toString (prop_focus_on_axis 1.428691 1.370142 1.311593))
...
#eval IO.println ("prop_grooved_reciprocal_yaw " ++ toString (prop_grooved_reciprocal_yaw 0.304923 0.246374 1.787825 1.729276 1.670728 1.612179 1.553630 1.495081 1.436532 1.377984 1.319435 1.260886))
#eval IO.println ("prop_grooved_reciprocal_yaw " ++ toString (prop_grooved_reciprocal_yaw 1.573731 1.515182 1.456633 1.398084 1.339536 1.280987 1.222438 1.163889 1.105340 1.046792 0.988243 0.929694))
#eval IO.println ("prop_grooved_reciprocal_yaw " ++ toString (prop_grooved_reciprocal_yaw 1.242539 1.183990 1.125441 1.066892 1.008344 0.949795 0.891246 0.832697 0.774148 0.715600 0.657051 0.598502))
...
#eval IO.println ("prop_grooved_relation_x " ++ toString (prop_grooved_relation_x 1.718771 1.660222 1.601673 1.543124 1.484576 1.426027 1.367478 1.308929 1.250380 1.191832 1.133283 1.074734))
#eval IO.println ("prop_grooved_relation_x " ++ toString (prop_grooved_relation_x 1.387579 1.329030 1.270481 1.211932 1.153384 1.094835 1.036286 0.977737 0.919188 0.860640 0.802091 0.743542))
#eval IO.println ("prop_grooved_relation_x " ++ toString (prop_grooved_relation_x 1.056387 0.997838 0.939289 0.880740 0.822192 0.763643 0.705094 0.646545 0.587996 0.529448 0.470899 0.412350))
...
#eval IO.println ("prop_grooved_relation_y " ++ toString (prop_grooved_relation_y 1.532619 1.474070 1.415521 1.356972 1.298424 1.239875 1.181326 1.122777 1.064228 1.005680 0.947131 0.888582))
#eval IO.println ("prop_grooved_relation_y " ++ toString (prop_grooved_relation_y 1.201427 1.142878 1.084329 1.025780 0.967232 0.908683 0.850134 0.791585 0.733036 0.674488 0.615939 0.557390))
#eval IO.println ("prop_grooved_relation_y " ++ toString (prop_grooved_relation_y 0.870235 0.811686 0.753137 0.694588 0.636040 0.577491 0.518942 0.460393 0.401844 0.343296 0.284747 0.226198))
...
#eval IO.println ("prop_hinge_freedom " ++ toString (prop_hinge_freedom 1.643403 1.584854 1.526305 1.467756 1.409208 1.350659 1.292110 1.233561))
#eval IO.println ("prop_hinge_freedom " ++ toString (prop_hinge_freedom 1.312211 1.253662 1.195113 1.136564 1.078016 1.019467 0.960918 0.902369))
#eval IO.println ("prop_hinge_freedom " ++ toString (prop_hinge_freedom 0.981019 0.922470 0.863921 0.805372 0.746824 0.688275 0.629726 0.571177))
...
#eval IO.println ("prop_hinge_freedom_smul " ++ toString (prop_hinge_freedom_smul 1.457251 1.398702 1.340153 1.281604 1.223056 1.164507 1.105958 1.047409 0.988860))
#eval IO.println ("prop_hinge_freedom_smul " ++ toString (prop_hinge_freedom_smul 1.126059 1.067510 1.008961 0.950412 0.891864 0.833315 0.774766 0.716217 0.657668))
#eval IO.println ("prop_hinge_freedom_smul " ++ toString (prop_hinge_freedom_smul 0.794867 0.736318 0.677769 0.619220 0.560672 0.502123 0.443574 0.385025 0.326476))
...
#eval IO.println ("prop_hinge_reciprocal_swing " ++ toString (prop_hinge_reciprocal_swing 1.271099 1.212550 1.154001))
#eval IO.println ("prop_hinge_reciprocal_swing " ++ toString (prop_hinge_reciprocal_swing 0.939907 0.881358 0.822809))
#eval IO.println ("prop_hinge_reciprocal_swing " ++ toString (prop_hinge_reciprocal_swing 0.608715 0.550166 0.491617))
...
#eval IO.println ("prop_m12_carries_dish " ++ toString (prop_m12_carries_dish 0.712643))
#eval IO.println ("prop_m12_carries_dish " ++ toString (prop_m12_carries_dish 0.381451))
#eval IO.println ("prop_m12_carries_dish " ++ toString (prop_m12_carries_dish 1.650259))
...
#eval IO.println ("prop_mastClears_hashemi_iff " ++ toString (prop_mastClears_hashemi_iff 0.340339))
#eval IO.println ("prop_mastClears_hashemi_iff " ++ toString (prop_mastClears_hashemi_iff 1.609147))
#eval IO.println ("prop_mastClears_hashemi_iff " ++ toString (prop_mastClears_hashemi_iff 1.277955))
...
#eval IO.println ("prop_mul_bounds_neg_pos " ++ toString (prop_mul_bounds_neg_pos 1.381883 1.323334 1.264785 1.206236 1.147688 1.089139))
#eval IO.println ("prop_mul_bounds_neg_pos " ++ toString (prop_mul_bounds_neg_pos 1.050691 0.992142 0.933593 0.875044 0.816496 0.757947))
#eval IO.println ("prop_mul_bounds_neg_pos " ++ toString (prop_mul_bounds_neg_pos 0.719499 0.660950 0.602401 0.543852 0.485304 0.426755))
...
#eval IO.println ("prop_mul_bounds_pos_pos " ++ toString (prop_mul_bounds_pos_pos 1.195731 1.137182 1.078633 1.020084 0.961536 0.902987))
#eval IO.println ("prop_mul_bounds_pos_pos " ++ toString (prop_mul_bounds_pos_pos 0.864539 0.805990 0.747441 0.688892 0.630344 0.571795))
#eval IO.println ("prop_mul_bounds_pos_pos " ++ toString (prop_mul_bounds_pos_pos 0.533347 0.474798 0.416249 0.357700 0.299152 0.240603))
...
#eval IO.println ("prop_play_budget " ++ toString (prop_play_budget 0.637275 0.578726 0.520177 0.461628))
#eval IO.println ("prop_play_budget " ++ toString (prop_play_budget 0.306083 0.247534 1.788985 1.730436))
#eval IO.println ("prop_play_budget " ++ toString (prop_play_budget 1.574891 1.516342 1.457793 1.399244))

def prop_plumbed_shift (eps : Float) : Bool :=
  (!((0 : Float) <= eps) || (!(eps <= (0.0005 : Float)) || (((1.30 : Float) * (Float.sin eps)) <= (0.00065 : Float))))

#eval IO.println ("prop_plumbed_shift " ++ toString (prop_plumbed_shift 0.451123))
#eval IO.println ("prop_plumbed_shift " ++ toString (prop_plumbed_shift 1.719931))
#eval IO.println ("prop_plumbed_shift " ++ toString (prop_plumbed_shift 1.388739))
...
#eval IO.println ("prop_postTop_on_rail " ++ toString (prop_postTop_on_rail 0.264971 0.206422 1.747873 1.689324 1.630776 1.572227 1.513678 1.455129 1.396580 1.338032 1.279483 1.220934))
#eval IO.println ("prop_postTop_on_rail " ++ toString (prop_postTop_on_rail 1.533779 1.475230 1.416681 1.358132 1.299584 1.241035 1.182486 1.123937 1.065388 1.006840 0.948291 0.889742))
#eval IO.println ("prop_postTop_on_rail " ++ toString (prop_postTop_on_rail 1.202587 1.144038 1.085489 1.026940 0.968392 0.909843 0.851294 0.792745 0.734196 0.675648 0.617099 0.558550))
...
#eval IO.println ("prop_postTops_apart " ++ toString (prop_postTops_apart 1.678819 1.620270 1.561721 1.503172 1.444624 1.386075 1.327526 1.268977 1.210428 1.151880 1.093331 1.034782))
#eval IO.println ("prop_postTops_apart " ++ toString (prop_postTops_apart 1.347627 1.289078 1.230529 1.171980 1.113432 1.054883 0.996334 0.937785 0.879236 0.820688 0.762139 0.703590))
#eval IO.println ("prop_postTops_apart " ++ toString (prop_postTops_apart 1.016435 0.957886 0.899337 0.840788 0.782240 0.723691 0.665142 0.606593 0.548044 0.489496 0.430947 0.372398))
...
#eval IO.println ("prop_postTops_level " ++ toString (prop_postTops_level 1.492667 1.434118 1.375569 1.317020 1.258472 1.199923 1.141374 1.082825 1.024276 0.965728 0.907179 0.848630))
#eval IO.println ("prop_postTops_level " ++ toString (prop_postTops_level 1.161475 1.102926 1.044377 0.985828 0.927280 0.868731 0.810182 0.751633 0.693084 0.634536 0.575987 0.517438))
#eval IO.println ("prop_postTops_level " ++ toString (prop_postTops_level 0.830283 0.771734 0.713185 0.654636 0.596088 0.537539 0.478990 0.420441 0.361892 0.303344 0.244795 1.786246))
...
#eval IO.println ("prop_postTops_offAxis " ++ toString (prop_postTops_offAxis 1.306515 1.247966 1.189417 1.130868 1.072320 1.013771 0.955222 0.896673 0.838124 0.779576 0.721027 0.662478 0.603929))
#eval IO.println ("prop_postTops_offAxis " ++ toString (prop_postTops_offAxis 0.975323 0.916774 0.858225 0.799676 0.741128 0.682579 0.624030 0.565481 0.506932 0.448384 0.389835 0.331286 0.272737))
#eval IO.println ("prop_postTops_offAxis " ++ toString (prop_postTops_offAxis 0.644131 0.585582 0.527033 0.468484 0.409936 0.351387 0.292838 0.234289 1.775740 1.717192 1.658643 1.600094 1.541545))
...
#eval IO.println ("prop_reachesVertical_iff " ++ toString (prop_reachesVertical_iff 0.934211 0.875662 0.817113 0.758564))
#eval IO.println ("prop_reachesVertical_iff " ++ toString (prop_reachesVertical_iff 0.603019 0.544470 0.485921 0.427372))
#eval IO.println ("prop_reachesVertical_iff " ++ toString (prop_reachesVertical_iff 0.271827 0.213278 1.754729 1.696180))
...
#eval IO.println ("prop_rim_under_F_iff " ++ toString (prop_rim_under_F_iff 0.561907 0.503358 0.444809))
#eval IO.println ("prop_rim_under_F_iff " ++ toString (prop_rim_under_F_iff 0.230715 1.772166 1.713617))
#eval IO.println ("prop_rim_under_F_iff " ++ toString (prop_rim_under_F_iff 1.499523 1.440974 1.382425))
...
#eval IO.println ("prop_rollerRadius_pos " ++ toString (prop_rollerRadius_pos 1.417299 1.358750 1.300201 1.241652 1.183104 1.124555))
#eval IO.println ("prop_rollerRadius_pos " ++ toString (prop_rollerRadius_pos 1.086107 1.027558 0.969009 0.910460 0.851912 0.793363))
#eval IO.println ("prop_rollerRadius_pos " ++ toString (prop_rollerRadius_pos 0.754915 0.696366 0.637817 0.579268 0.520720 0.462171))
...
#eval IO.println ("prop_rollerRadius_sq " ++ toString (prop_rollerRadius_sq 1.231147 1.172598 1.114049 1.055500 0.996952 0.938403))
#eval IO.println ("prop_rollerRadius_sq " ++ toString (prop_rollerRadius_sq 0.899955 0.841406 0.782857 0.724308 0.665760 0.607211))
#eval IO.println ("prop_rollerRadius_sq " ++ toString (prop_rollerRadius_sq 0.568763 0.510214 0.451665 0.393116 0.334568 0.276019))
...
#eval IO.println ("prop_rotz_dot " ++ toString (prop_rotz_dot 0.858843 0.800294 0.741745 0.683196 0.624648 0.566099 0.507550))
#eval IO.println ("prop_rotz_dot " ++ toString (prop_rotz_dot 0.527651 0.469102 0.410553 0.352004 0.293456 0.234907 1.776358))
#eval IO.println ("prop_rotz_dot " ++ toString (prop_rotz_dot 1.796459 1.737910 1.679361 1.620812 1.562264 1.503715 1.445166))
...
#eval IO.println ("prop_screwLength_eq_focal " ++ toString (prop_screwLength_eq_focal 0.672691 0.614142))
#eval IO.println ("prop_screwLength_eq_focal " ++ toString (prop_screwLength_eq_focal 0.341499 0.282950))
#eval IO.println ("prop_screwLength_eq_focal " ++ toString (prop_screwLength_eq_focal 1.610307 1.551758))
...
#eval IO.println ("prop_screwTwist_zero " ++ toString (prop_screwTwist_zero 1.714235 1.655686))
#eval IO.println ("prop_screwTwist_zero " ++ toString (prop_screwTwist_zero 1.383043 1.324494))
#eval IO.println ("prop_screwTwist_zero " ++ toString (prop_screwTwist_zero 1.051851 0.993302))
...
#eval IO.println ("prop_screw_freedom " ++ toString (prop_screw_freedom 1.528083 1.469534 1.410985 1.352436 1.293888 1.235339 1.176790 1.118241 1.059692))
#eval IO.println ("prop_screw_freedom " ++ toString (prop_screw_freedom 1.196891 1.138342 1.079793 1.021244 0.962696 0.904147 0.845598 0.787049 0.728500))
#eval IO.println ("prop_screw_freedom " ++ toString (prop_screw_freedom 0.865699 0.807150 0.748601 0.690052 0.631504 0.572955 0.514406 0.455857 0.397308))
...
#eval IO.println ("prop_screw_reciprocal " ++ toString (prop_screw_reciprocal 1.341931 1.283382 1.224833))
#eval IO.println ("prop_screw_reciprocal " ++ toString (prop_screw_reciprocal 1.010739 0.952190 0.893641))
#eval IO.println ("prop_screw_reciprocal " ++ toString (prop_screw_reciprocal 0.679547 0.620998 0.562449))
...
#eval IO.println ("prop_slackHarmless_of_budget " ++ toString (prop_slackHarmless_of_budget 0.597323 0.538774 0.480225 0.421676))
#eval IO.println ("prop_slackHarmless_of_budget " ++ toString (prop_slackHarmless_of_budget 0.266131 0.207582 1.749033 1.690484))
#eval IO.println ("prop_slackHarmless_of_budget " ++ toString (prop_slackHarmless_of_budget 1.534939 1.476390 1.417841 1.359292))
...
#eval IO.println ("prop_slackHarmless_of_lever " ++ toString (prop_slackHarmless_of_lever 0.411171 0.352622 0.294073 0.235524 1.776976))
#eval IO.println ("prop_slackHarmless_of_lever " ++ toString (prop_slackHarmless_of_lever 1.679979 1.621430 1.562881 1.504332 1.445784))
#eval IO.println ("prop_slackHarmless_of_lever " ++ toString (prop_slackHarmless_of_lever 1.348787 1.290238 1.231689 1.173140 1.114592))
...
#eval IO.println ("prop_sq_bounds_neg " ++ toString (prop_sq_bounds_neg 1.638867 1.580318 1.521769))
#eval IO.println ("prop_sq_bounds_neg " ++ toString (prop_sq_bounds_neg 1.307675 1.249126 1.190577))
#eval IO.println ("prop_sq_bounds_neg " ++ toString (prop_sq_bounds_neg 0.976483 0.917934 0.859385))
...
#eval IO.println ("prop_strut_resists_lean " ++ toString (prop_strut_resists_lean 1.266563 1.208014 1.149465 1.090916 1.032368 0.973819 0.915270 0.856721 0.798172 0.739624))
#eval IO.println ("prop_strut_resists_lean " ++ toString (prop_strut_resists_lean 0.935371 0.876822 0.818273 0.759724 0.701176 0.642627 0.584078 0.525529 0.466980 0.408432))
#eval IO.println ("prop_strut_resists_lean " ++ toString (prop_strut_resists_lean 0.604179 0.545630 0.487081 0.428532 0.369984 0.311435 0.252886 1.794337 1.735788 1.677240))
...
#eval IO.println ("prop_sunDir_rot " ++ toString (prop_sunDir_rot 1.080411 1.021862 0.963313))
#eval IO.println ("prop_sunDir_rot " ++ toString (prop_sunDir_rot 0.749219 0.690670 0.632121))
#eval IO.println ("prop_sunDir_rot " ++ toString (prop_sunDir_rot 0.418027 0.359478 0.300929))
...
#eval IO.println ("prop_sunInDish_equivariant " ++ toString (prop_sunInDish_equivariant 0.894259 0.835710 0.777161 0.718612 0.660064))
#eval IO.println ("prop_sunInDish_equivariant " ++ toString (prop_sunInDish_equivariant 0.563067 0.504518 0.445969 0.387420 0.328872))
#eval IO.println ("prop_sunInDish_equivariant " ++ toString (prop_sunInDish_equivariant 0.231875 1.773326 1.714777 1.656228 1.597680))
...
#eval IO.println ("prop_swingFocus_circle " ++ toString (prop_swingFocus_circle 0.708107 0.649558 0.591009 0.532460 0.473912))
#eval IO.println ("prop_swingFocus_circle " ++ toString (prop_swingFocus_circle 0.376915 0.318366 0.259817 0.201268 1.742720))
#eval IO.println ("prop_swingFocus_circle " ++ toString (prop_swingFocus_circle 1.645723 1.587174 1.528625 1.470076 1.411528))

def prop_swingNormal_unit (t : Float) : Bool :=
  (feq (((-(Float.sin t)) ^ 2) + ((Float.cos t) ^ 2)) (1 : Float))

#eval IO.println ("prop_swingNormal_unit " ++ toString (prop_swingNormal_unit 0.521955))
#eval IO.println ("prop_swingNormal_unit " ++ toString (prop_swingNormal_unit 1.790763))
#eval IO.println ("prop_swingNormal_unit " ++ toString (prop_swingNormal_unit 1.459571))
...
#eval IO.println ("prop_swing_focusCircle " ++ toString (prop_swing_focusCircle 0.335803 0.277254 0.218705 1.760156))
#eval IO.println ("prop_swing_focusCircle " ++ toString (prop_swing_focusCircle 1.604611 1.546062 1.487513 1.428964))
#eval IO.println ("prop_swing_focusCircle " ++ toString (prop_swing_focusCircle 1.273419 1.214870 1.156321 1.097772))
...
#eval IO.println ("prop_swing_lift " ++ toString (prop_swing_lift 1.749651 1.691102 1.632553 1.574004 1.515456))
#eval IO.println ("prop_swing_lift " ++ toString (prop_swing_lift 1.418459 1.359910 1.301361 1.242812 1.184264))
#eval IO.println ("prop_swing_lift " ++ toString (prop_swing_lift 1.087267 1.028718 0.970169 0.911620 0.853072))
...
#eval IO.println ("prop_tension_le_of_holds " ++ toString (prop_tension_le_of_holds 1.563499 1.504950 1.446401 1.387852 1.329304))
#eval IO.println ("prop_tension_le_of_holds " ++ toString (prop_tension_le_of_holds 1.232307 1.173758 1.115209 1.056660 0.998112))
#eval IO.println ("prop_tension_le_of_holds " ++ toString (prop_tension_le_of_holds 0.901115 0.842566 0.784017 0.725468 0.666920))

def prop_trackerBudget_iff (f : Float) (eps : Float) (h : Float) : Bool :=
  let v3 := (Float.tan eps)
  (!((0 : Float) < f) || (((f * v3) <= h) == (v3 <= (h / f))))

#eval IO.println ("prop_trackerBudget_iff " ++ toString (prop_trackerBudget_iff 1.377347 1.318798 1.260249))
#eval IO.println ("prop_trackerBudget_iff " ++ toString (prop_trackerBudget_iff 1.046155 0.987606 0.929057))
#eval IO.println ("prop_trackerBudget_iff " ++ toString (prop_trackerBudget_iff 0.714963 0.656414 0.597865))

def prop_tracker_margin_hashemi (eps : Float) : Bool :=
  let v1 := (Float.tan eps)
  ((((1 : Float) * v1) <= (0.03 : Float)) == (v1 <= (0.03 : Float)))

#eval IO.println ("prop_tracker_margin_hashemi " ++ toString (prop_tracker_margin_hashemi 1.191195))
#eval IO.println ("prop_tracker_margin_hashemi " ++ toString (prop_tracker_margin_hashemi 0.860003))
#eval IO.println ("prop_tracker_margin_hashemi " ++ toString (prop_tracker_margin_hashemi 0.528811))
...
#eval IO.println ("prop_tracking_power_tiny " ++ toString (prop_tracking_power_tiny 1.005043 0.946494 0.887945 0.829396))
#eval IO.println ("prop_tracking_power_tiny " ++ toString (prop_tracking_power_tiny 0.673851 0.615302 0.556753 0.498204))
#eval IO.println ("prop_tracking_power_tiny " ++ toString (prop_tracking_power_tiny 0.342659 0.284110 0.225561 1.767012))
...
#eval IO.println ("prop_wireLever_edge_formula " ++ toString (prop_wireLever_edge_formula 0.632739 0.574190 0.515641 0.457092 0.398544))
#eval IO.println ("prop_wireLever_edge_formula " ++ toString (prop_wireLever_edge_formula 0.301547 0.242998 1.784449 1.725900 1.667352))
#eval IO.println ("prop_wireLever_edge_formula " ++ toString (prop_wireLever_edge_formula 1.570355 1.511806 1.453257 1.394708 1.336160))
...
#eval IO.println ("prop_wireLever_pos_iff " ++ toString (prop_wireLever_pos_iff 0.446587 0.388038 0.329489 0.270940))
#eval IO.println ("prop_wireLever_pos_iff " ++ toString (prop_wireLever_pos_iff 1.715395 1.656846 1.598297 1.539748))
#eval IO.println ("prop_wireLever_pos_iff " ++ toString (prop_wireLever_pos_iff 1.384203 1.325654 1.267105 1.208556))
...
#eval IO.println ("prop_wireLever_rest " ++ toString (prop_wireLever_rest 0.260435 0.201886 1.743337 1.684788))
#eval IO.println ("prop_wireLever_rest " ++ toString (prop_wireLever_rest 1.529243 1.470694 1.412145 1.353596))
#eval IO.println ("prop_wireLever_rest " ++ toString (prop_wireLever_rest 1.198051 1.139502 1.080953 1.022404))
...
#eval IO.println ("prop_wire_recip_swing " ++ toString (prop_wire_recip_swing 1.301979 1.243430 1.184881 1.126332 1.067784 1.009235 0.950686 0.892137))
#eval IO.println ("prop_wire_recip_swing " ++ toString (prop_wire_recip_swing 0.970787 0.912238 0.853689 0.795140 0.736592 0.678043 0.619494 0.560945))
#eval IO.println ("prop_wire_recip_swing " ++ toString (prop_wire_recip_swing 0.639595 0.581046 0.522497 0.463948 0.405400 0.346851 0.288302 0.229753))
...
#eval IO.println ("prop_wire_taut_iff " ++ toString (prop_wire_taut_iff 0.929675 0.871126 0.812577 0.754028))
#eval IO.println ("prop_wire_taut_iff " ++ toString (prop_wire_taut_iff 0.598483 0.539934 0.481385 0.422836))
#eval IO.println ("prop_wire_taut_iff " ++ toString (prop_wire_taut_iff 0.267291 0.208742 1.750193 1.691644))

def prop_yaw_lifts_nothing (p_0 : Float) (p_1 : Float) (p_2 : Float) : Bool :=
  (feq ((((0 : Float) * p_1) - ((0 : Float) * p_0)) + (0 : Float)) (0 : Float))

#eval IO.println ("prop_yaw_lifts_nothing " ++ toString (prop_yaw_lifts_nothing 0.743523 0.684974 0.626425))
#eval IO.println ("prop_yaw_lifts_nothing " ++ toString (prop_yaw_lifts_nothing 0.412331 0.353782 0.295233))
#eval IO.println ("prop_yaw_lifts_nothing " ++ toString (prop_yaw_lifts_nothing 1.681139 1.622590 1.564041))
...
#eval IO.println ("pulleyAt " ++ toString ((pulleyAt 0.371219 0.312670).map Float.toBits))
#eval IO.println ("pulleyAt " ++ toString ((pulleyAt 1.640027 1.581478).map Float.toBits))
#eval IO.println ("pulleyAt " ++ toString ((pulleyAt 1.308835 1.250286).map Float.toBits))
...
#eval IO.println ("qAbs " ++ toString (qAbs 1.598915 1.540366).toBits)
#eval IO.println ("qAbs " ++ toString (qAbs 1.267723 1.209174).toBits)
#eval IO.println ("qAbs " ++ toString (qAbs 0.936531 0.877982).toBits)

def qCoilLoss (eps : Float) (Ac : Float) (hC : Float) (Toil : Float) (Ta : Float) : Float :=
  ((((eps * (0.0000000567 : Float)) * Ac) * ((Toil ^ 4) - (Ta ^ 4))) + ((hC * Ac) * (Toil - Ta)))

#eval IO.println ("qCoilLoss " ++ toString (qCoilLoss 1.412763 1.354214 1.295665 1.237116 1.178568).toBits)
#eval IO.println ("qCoilLoss " ++ toString (qCoilLoss 1.081571 1.023022 0.964473 0.905924 0.847376).toBits)
#eval IO.println ("qCoilLoss " ++ toString (qCoilLoss 0.750379 0.691830 0.633281 0.574732 0.516184).toBits)
...
#eval IO.println ("qNet " ++ toString (qNet 1.226611 1.168062 1.109513 1.050964 0.992416 0.933867 0.875318 0.816769 0.758220 0.699672).toBits)
#eval IO.println ("qNet " ++ toString (qNet 0.895419 0.836870 0.778321 0.719772 0.661224 0.602675 0.544126 0.485577 0.427028 0.368480).toBits)
#eval IO.println ("qNet " ++ toString (qNet 0.564227 0.505678 0.447129 0.388580 0.330032 0.271483 0.212934 1.754385 1.695836 1.637288).toBits)
...
#eval IO.println ("check_qNet_antitone " ++ toString (check_qNet_antitone 1.040459 0.981910 0.923361 0.864812 0.806264 0.747715 0.689166 0.630617 0.572068 0.513520 0.454971))
#eval IO.println ("check_qNet_antitone " ++ toString (check_qNet_antitone 0.709267 0.650718 0.592169 0.533620 0.475072 0.416523 0.357974 0.299425 0.240876 1.782328 1.723779))
#eval IO.println ("check_qNet_antitone " ++ toString (check_qNet_antitone 0.378075 0.319526 0.260977 0.202428 1.743880 1.685331 1.626782 1.568233 1.509684 1.451136 1.392587))
...
#eval IO.println ("check_qNet_lipschitz " ++ toString (check_qNet_lipschitz 0.854307 0.795758 0.737209 0.678660 0.620112 0.561563 0.503014 0.444465 0.385916 0.327368 0.268819 0.210270))
#eval IO.println ("check_qNet_lipschitz " ++ toString (check_qNet_lipschitz 0.523115 0.464566 0.406017 0.347468 0.288920 0.230371 1.771822 1.713273 1.654724 1.596176 1.537627 1.479078))
#eval IO.println ("check_qNet_lipschitz " ++ toString (check_qNet_lipschitz 1.791923 1.733374 1.674825 1.616276 1.557728 1.499179 1.440630 1.382081 1.323532 1.264984 1.206435 1.147886))
...
#eval IO.println ("check_qNet_strictAnti " ++ toString (check_qNet_strictAnti 0.668155 0.609606 0.551057 0.492508 0.433960 0.375411 0.316862 0.258313 1.799764 1.741216 1.682667))
#eval IO.println ("check_qNet_strictAnti " ++ toString (check_qNet_strictAnti 0.336963 0.278414 0.219865 1.761316 1.702768 1.644219 1.585670 1.527121 1.468572 1.410024 1.351475))
#eval IO.println ("check_qNet_strictAnti " ++ toString (check_qNet_strictAnti 1.605771 1.547222 1.488673 1.430124 1.371576 1.313027 1.254478 1.195929 1.137380 1.078832 1.020283))

def qPipe (Upipe : Float) (Toil : Float) (Ta : Float) : Float :=
  (Upipe * (Toil - Ta))

#eval IO.println ("qPipe " ++ toString (qPipe 0.482003 0.423454 0.364905).toBits)
#eval IO.println ("qPipe " ++ toString (qPipe 1.750811 1.692262 1.633713).toBits)
#eval IO.println ("qPipe " ++ toString (qPipe 1.419619 1.361070 1.302521).toBits)

def qPot (UAx : Float) (Toil : Float) (Twall : Float) : Float :=
  (max (0 : Float) (UAx * (Toil - Twall)))

#eval IO.println ("qPot " ++ toString (qPot 0.295851 0.237302 1.778753).toBits)
#eval IO.println ("qPot " ++ toString (qPot 1.564659 1.506110 1.447561).toBits)
#eval IO.println ("qPot " ++ toString (qPot 1.233467 1.174918 1.116369).toBits)

def check_qPot_le (UAx : Float) (Toil : Float) (Twall : Float) : Bool :=
  let v5 := (Toil - Twall)
  (!((0 : Float) <= UAx) || ((max (0 : Float) (UAx * v5)) <= (UAx * (max (0 : Float) v5))))

#eval IO.println ("check_qPot_le " ++ toString (check_qPot_le 1.709699 1.651150 1.592601))
#eval IO.println ("check_qPot_le " ++ toString (check_qPot_le 1.378507 1.319958 1.261409))
#eval IO.println ("check_qPot_le " ++ toString (check_qPot_le 1.047315 0.988766 0.930217))

def check_qPot_nonneg (UAx : Float) (Toil : Float) (Twall : Float) : Bool :=
  ((0 : Float) <= (max (0 : Float) (UAx * (Toil - Twall))))

#eval IO.println ("check_qPot_nonneg " ++ toString (check_qPot_nonneg 1.523547 1.464998 1.406449))
#eval IO.println ("check_qPot_nonneg " ++ toString (check_qPot_nonneg 1.192355 1.133806 1.075257))
#eval IO.println ("check_qPot_nonneg " ++ toString (check_qPot_nonneg 0.861163 0.802614 0.744065))
...
#eval IO.println ("check_reachesVertical_iff " ++ toString (check_reachesVertical_iff 0.965091 0.906542 0.847993 0.789444))
#eval IO.println ("check_reachesVertical_iff " ++ toString (check_reachesVertical_iff 0.633899 0.575350 0.516801 0.458252))
#eval IO.println ("check_reachesVertical_iff " ++ toString (check_reachesVertical_iff 0.302707 0.244158 1.785609 1.727060))
...
#eval IO.println ("recip " ++ toString (recip 0.592787 0.534238 0.475689 0.417140 0.358592 0.300043 0.241494 1.782945 1.724396 1.665848 1.607299 1.548750).toBits)
#eval IO.println ("recip " ++ toString (recip 0.261595 0.203046 1.744497 1.685948 1.627400 1.568851 1.510302 1.451753 1.393204 1.334656 1.276107 1.217558).toBits)
#eval IO.println ("recip " ++ toString (recip 1.530403 1.471854 1.413305 1.354756 1.296208 1.237659 1.179110 1.120561 1.062012 1.003464 0.944915 0.886366).toBits)
...
#eval IO.println ("reflect3 " ++ toString ((reflect3 0.406635 0.348086 0.289537 0.230988 1.772440 1.713891).map Float.toBits))
#eval IO.println ("reflect3 " ++ toString ((reflect3 1.675443 1.616894 1.558345 1.499796 1.441248 1.382699).map Float.toBits))
#eval IO.println ("reflect3 " ++ toString ((reflect3 1.344251 1.285702 1.227153 1.168604 1.110056 1.051507).map Float.toBits))
...
#eval IO.println ("check_rim_under_F_iff " ++ toString (check_rim_under_F_iff 1.634331 1.575782 1.517233))
#eval IO.println ("check_rim_under_F_iff " ++ toString (check_rim_under_F_iff 1.303139 1.244590 1.186041))
#eval IO.println ("check_rim_under_F_iff " ++ toString (check_rim_under_F_iff 0.971947 0.913398 0.854849))
...
#eval IO.println ("rollY " ++ toString ((rollY 1.075875 1.017326 0.958777).map Float.toBits))
#eval IO.println ("rollY " ++ toString ((rollY 0.744683 0.686134 0.627585).map Float.toBits))
#eval IO.println ("rollY " ++ toString ((rollY 0.413491 0.354942 0.296393).map Float.toBits))
...
#eval IO.println ("rollerRadius " ++ toString (rollerRadius 0.889723 0.831174 0.772625 0.714076 0.655528 0.596979).toBits)
#eval IO.println ("rollerRadius " ++ toString (rollerRadius 0.558531 0.499982 0.441433 0.382884 0.324336 0.265787).toBits)
#eval IO.println ("rollerRadius " ++ toString (rollerRadius 0.227339 1.768790 1.710241 1.651692 1.593144 1.534595).toBits)
...
#eval IO.println ("check_rollerRadius_pos " ++ toString (check_rollerRadius_pos 0.331267 0.272718 0.214169 1.755620 1.697072 1.638523))
#eval IO.println ("check_rollerRadius_pos " ++ toString (check_rollerRadius_pos 1.600075 1.541526 1.482977 1.424428 1.365880 1.307331))
#eval IO.println ("check_rollerRadius_pos " ++ toString (check_rollerRadius_pos 1.268883 1.210334 1.151785 1.093236 1.034688 0.976139))

def check_rollerRadius_sq (c_chord : Float) (c_apexH : Float) (c_aBase : Float) (c_cross : Float) (c_barW : Float) (c_rDrive : Float) : Bool :=
  let v10 := (((c_chord / (2 : Float)) ^ 2) + (c_apexH ^ 2))
  (feq ((Float.sqrt v10) ^ 2) v10)

#eval IO.println ("check_rollerRadius_sq " ++ toString (check_rollerRadius_sq 1.745115 1.686566 1.628017 1.569468 1.510920 1.452371))
#eval IO.println ("check_rollerRadius_sq " ++ toString (check_rollerRadius_sq 1.413923 1.355374 1.296825 1.238276 1.179728 1.121179))
#eval IO.println ("check_rollerRadius_sq " ++ toString (check_rollerRadius_sq 1.082731 1.024182 0.965633 0.907084 0.848536 0.789987))
...
#eval IO.println ("rot " ++ toString ((rot 1.372811 1.314262 1.255713).map Float.toBits))
#eval IO.println ("rot " ++ toString ((rot 1.041619 0.983070 0.924521).map Float.toBits))
#eval IO.println ("rot " ++ toString ((rot 0.710427 0.651878 0.593329).map Float.toBits))
...
#eval IO.println ("rotz " ++ toString ((rotz 1.186659 1.128110 1.069561 1.011012).map Float.toBits))
#eval IO.println ("rotz " ++ toString ((rotz 0.855467 0.796918 0.738369 0.679820).map Float.toBits))
#eval IO.println ("rotz " ++ toString ((rotz 0.524275 0.465726 0.407177 0.348628).map Float.toBits))
...
#eval IO.println ("check_rotz_dot " ++ toString (check_rotz_dot 1.000507 0.941958 0.883409 0.824860 0.766312 0.707763 0.649214))
#eval IO.println ("check_rotz_dot " ++ toString (check_rotz_dot 0.669315 0.610766 0.552217 0.493668 0.435120 0.376571 0.318022))
#eval IO.println ("check_rotz_dot " ++ toString (check_rotz_dot 0.338123 0.279574 0.221025 1.762476 1.703928 1.645379 1.586830))
...
#eval IO.println ("sampleRay " ++ toString ((sampleRay 0.814355 0.755806 0.697257 0.638708 0.580160 0.521611 0.463062 0.404513 0.345964 0.287416 0.228867 1.770318).map Float.toBits))
#eval IO.println ("sampleRay " ++ toString ((sampleRay 0.483163 0.424614 0.366065 0.307516 0.248968 1.790419 1.731870 1.673321 1.614772 1.556224 1.497675 1.439126).map Float.toBits))
#eval IO.println ("sampleRay " ++ toString ((sampleRay 1.751971 1.693422 1.634873 1.576324 1.517776 1.459227 1.400678 1.342129 1.283580 1.225032 1.166483 1.107934).map Float.toBits))

def screwLength (R : Float) (a : Float) : Float :=
  ((R / (2 : Float)) - (R - (Float.sqrt ((R ^ 2) - (a ^ 2)))))

#eval IO.println ("screwLength " ++ toString (screwLength 0.628203 0.569654).toBits)
#eval IO.println ("screwLength " ++ toString (screwLength 0.297011 0.238462).toBits)
#eval IO.println ("screwLength " ++ toString (screwLength 1.565819 1.507270).toBits)
...
#eval IO.println ("check_screwLength_eq_focal " ++ toString (check_screwLength_eq_focal 0.442051 0.383502))
#eval IO.println ("check_screwLength_eq_focal " ++ toString (check_screwLength_eq_focal 1.710859 1.652310))
#eval IO.println ("check_screwLength_eq_focal " ++ toString (check_screwLength_eq_focal 1.379667 1.321118))
...
#eval IO.println ("screwTwist " ++ toString ((screwTwist 1.483595 1.425046).map Float.toBits))
#eval IO.println ("screwTwist " ++ toString ((screwTwist 1.152403 1.093854).map Float.toBits))
#eval IO.println ("screwTwist " ++ toString ((screwTwist 0.821211 0.762662).map Float.toBits))
...
#eval IO.println ("check_screwTwist_zero " ++ toString (check_screwTwist_zero 1.297443 1.238894))
#eval IO.println ("check_screwTwist_zero " ++ toString (check_screwTwist_zero 0.966251 0.907702))
#eval IO.println ("check_screwTwist_zero " ++ toString (check_screwTwist_zero 0.635059 0.576510))
...
#eval IO.println ("screwWrench " ++ toString ((screwWrench 1.111291 1.052742 0.994193).map Float.toBits))
#eval IO.println ("screwWrench " ++ toString ((screwWrench 0.780099 0.721550 0.663001).map Float.toBits))
#eval IO.println ("screwWrench " ++ toString ((screwWrench 0.448907 0.390358 0.331809).map Float.toBits))
...
#eval IO.println ("check_screw_freedom " ++ toString (check_screw_freedom 0.925139 0.866590 0.808041 0.749492 0.690944 0.632395 0.573846 0.515297 0.456748))
#eval IO.println ("check_screw_freedom " ++ toString (check_screw_freedom 0.593947 0.535398 0.476849 0.418300 0.359752 0.301203 0.242654 1.784105 1.725556))
#eval IO.println ("check_screw_freedom " ++ toString (check_screw_freedom 0.262755 0.204206 1.745657 1.687108 1.628560 1.570011 1.511462 1.452913 1.394364))
...
#eval IO.println ("check_screw_reciprocal " ++ toString (check_screw_reciprocal 0.738987 0.680438 0.621889))
#eval IO.println ("check_screw_reciprocal " ++ toString (check_screw_reciprocal 0.407795 0.349246 0.290697))
#eval IO.println ("check_screw_reciprocal " ++ toString (check_screw_reciprocal 1.676603 1.618054 1.559505))

def setLength (rod : Float) (excess : Float) : Float :=
  (rod - excess)

#eval IO.println ("setLength " ++ toString (setLength 0.552835 0.494286).toBits)
#eval IO.println ("setLength " ++ toString (setLength 0.221643 1.763094).toBits)
#eval IO.println ("setLength " ++ toString (setLength 1.490451 1.431902).toBits)
...
#eval IO.println ("check_sigmoid_ge_of_nonneg " ++ toString (check_sigmoid_ge_of_nonneg 1.222075))
#eval IO.println ("check_sigmoid_ge_of_nonneg " ++ toString (check_sigmoid_ge_of_nonneg 0.890883))
#eval IO.println ("check_sigmoid_ge_of_nonneg " ++ toString (check_sigmoid_ge_of_nonneg 0.559691))

def check_sigmoid_slope_le (x : Float) : Bool :=
  let v1 := (1.0 / (1.0 + Float.exp (-x)))
  ((v1 * ((1 : Float) - v1)) <= ((1 : Float) / (4 : Float)))

#eval IO.println ("check_sigmoid_slope_le " ++ toString (check_sigmoid_slope_le 1.035923))
#eval IO.println ("check_sigmoid_slope_le " ++ toString (check_sigmoid_slope_le 0.704731))
#eval IO.println ("check_sigmoid_slope_le " ++ toString (check_sigmoid_slope_le 0.373539))
...
#eval IO.println ("check_slackHarmless_of_budget " ++ toString (check_slackHarmless_of_budget 0.663619 0.605070 0.546521 0.487972))
#eval IO.println ("check_slackHarmless_of_budget " ++ toString (check_slackHarmless_of_budget 0.332427 0.273878 0.215329 1.756780))
#eval IO.println ("check_slackHarmless_of_budget " ++ toString (check_slackHarmless_of_budget 1.601235 1.542686 1.484137 1.425588))
...
#eval IO.println ("check_slackHarmless_of_lever " ++ toString (check_slackHarmless_of_lever 0.477467 0.418918 0.360369 0.301820 0.243272))
#eval IO.println ("check_slackHarmless_of_lever " ++ toString (check_slackHarmless_of_lever 1.746275 1.687726 1.629177 1.570628 1.512080))
#eval IO.println ("check_slackHarmless_of_lever " ++ toString (check_slackHarmless_of_lever 1.415083 1.356534 1.297985 1.239436 1.180888))

def slackSpot (f : Float) (delta : Float) (rw : Float) : Float :=
  ((((2 : Float) * f) * delta) / rw)

#eval IO.println ("slackSpot " ++ toString (slackSpot 0.291315 0.232766 1.774217).toBits)
#eval IO.println ("slackSpot " ++ toString (slackSpot 1.560123 1.501574 1.443025).toBits)
#eval IO.println ("slackSpot " ++ toString (slackSpot 1.228931 1.170382 1.111833).toBits)

def slotExit (a : Float) (ze : Float) : Float :=
  (Float.atan (a / ze))

#eval IO.println ("slotExit " ++ toString (slotExit 1.705163 1.646614).toBits)
#eval IO.println ("slotExit " ++ toString (slotExit 1.373971 1.315422).toBits)
#eval IO.println ("slotExit " ++ toString (slotExit 1.042779 0.984230).toBits)
...
#eval IO.println ("sphereBestFocus " ++ toString (sphereBestFocus 1.332859 1.274310).toBits)
#eval IO.println ("sphereBestFocus " ++ toString (sphereBestFocus 1.001667 0.943118).toBits)
#eval IO.println ("sphereBestFocus " ++ toString (sphereBestFocus 0.670475 0.611926).toBits)
...
#eval IO.println ("sphereBlur " ++ toString (sphereBlur 1.146707 1.088158).toBits)
#eval IO.println ("sphereBlur " ++ toString (sphereBlur 0.815515 0.756966).toBits)
#eval IO.println ("sphereBlur " ++ toString (sphereBlur 0.484323 0.425774).toBits)
...
#eval IO.println ("sphereDev " ++ toString (sphereDev 0.960555 0.902006 0.843457).toBits)
#eval IO.println ("sphereDev " ++ toString (sphereDev 0.629363 0.570814 0.512265).toBits)
#eval IO.println ("sphereDev " ++ toString (sphereDev 0.298171 0.239622 1.781073).toBits)

def sphereFocal (R : Float) (h : Float) : Float :=
  (R - (R / ((2 : Float) * (Float.cos (Float.asin (h / R))))))

#eval IO.println ("sphereFocal " ++ toString (sphereFocal 0.774403 0.715854).toBits)
#eval IO.println ("sphereFocal " ++ toString (sphereFocal 0.443211 0.384662).toBits)
#eval IO.println ("sphereFocal " ++ toString (sphereFocal 1.712019 1.653470).toBits)
...
#eval IO.println ("sphereHit " ++ toString ((sphereHit 0.588251 0.529702 0.471153 0.412604 0.354056 0.295507 0.236958).map Float.toBits))
#eval IO.println ("sphereHit " ++ toString ((sphereHit 0.257059 1.798510 1.739961 1.681412 1.622864 1.564315 1.505766).map Float.toBits))
#eval IO.println ("sphereHit " ++ toString ((sphereHit 1.525867 1.467318 1.408769 1.350220 1.291672 1.233123 1.174574).map Float.toBits))
...
#eval IO.println ("check_sq_bounds_neg " ++ toString (check_sq_bounds_neg 0.215947 1.757398 1.698849))
#eval IO.println ("check_sq_bounds_neg " ++ toString (check_sq_bounds_neg 1.484755 1.426206 1.367657))
#eval IO.println ("check_sq_bounds_neg " ++ toString (check_sq_bounds_neg 1.153563 1.095014 1.036465))
...
#eval IO.println ("check_steady_conservation " ++ toString (check_steady_conservation 1.443643 1.385094 1.326545 1.267996 1.209448 1.150899 1.092350 1.033801 0.975252 0.916704))
#eval IO.println ("check_steady_conservation " ++ toString (check_steady_conservation 1.112451 1.053902 0.995353 0.936804 0.878256 0.819707 0.761158 0.702609 0.644060 0.585512))
#eval IO.println ("check_steady_conservation " ++ toString (check_steady_conservation 0.781259 0.722710 0.664161 0.605612 0.547064 0.488515 0.429966 0.371417 0.312868 0.254320))
...
#eval IO.println ("check_steady_pot_le_abs " ++ toString (check_steady_pot_le_abs 1.257491 1.198942 1.140393 1.081844 1.023296 0.964747 0.906198 0.847649 0.789100 0.730552))
#eval IO.println ("check_steady_pot_le_abs " ++ toString (check_steady_pot_le_abs 0.926299 0.867750 0.809201 0.750652 0.692104 0.633555 0.575006 0.516457 0.457908 0.399360))
#eval IO.println ("check_steady_pot_le_abs " ++ toString (check_steady_pot_le_abs 0.595107 0.536558 0.478009 0.419460 0.360912 0.302363 0.243814 1.785265 1.726716 1.668168))
...
#eval IO.println ("check_steady_unique " ++ toString (check_steady_unique 1.071339 1.012790 0.954241 0.895692 0.837144 0.778595 0.720046 0.661497 0.602948 0.544400 0.485851))
#eval IO.println ("check_steady_unique " ++ toString (check_steady_unique 0.740147 0.681598 0.623049 0.564500 0.505952 0.447403 0.388854 0.330305 0.271756 0.213208 1.754659))
#eval IO.println ("check_steady_unique " ++ toString (check_steady_unique 0.408955 0.350406 0.291857 0.233308 1.774760 1.716211 1.657662 1.599113 1.540564 1.482016 1.423467))
...
#eval IO.println ("step " ++ toString ((step 0.885187 0.826638 0.768089 0.709540 0.650992 0.592443 0.533894 0.475345 0.416796 0.358248 0.299699 0.241150 1.782601 1.724052 1.665504 1.606955).map Float.toBits))
#eval IO.println ("step " ++ toString ((step 0.553995 0.495446 0.436897 0.378348 0.319800 0.261251 0.202702 1.744153 1.685604 1.627056 1.568507 1.509958 1.451409 1.392860 1.334312 1.275763).map Float.toBits))
#eval IO.println ("step " ++ toString ((step 0.222803 1.764254 1.705705 1.647156 1.588608 1.530059 1.471510 1.412961 1.354412 1.295864 1.237315 1.178766 1.120217 1.061668 1.003120 0.944571).map Float.toBits))
...
#eval IO.println ("strutStrain " ++ toString (strutStrain 0.512883 0.454334 0.395785 0.337236 0.278688 0.220139 1.761590 1.703041 1.644492).toBits)
#eval IO.println ("strutStrain " ++ toString (strutStrain 1.781691 1.723142 1.664593 1.606044 1.547496 1.488947 1.430398 1.371849 1.313300).toBits)
#eval IO.println ("strutStrain " ++ toString (strutStrain 1.450499 1.391950 1.333401 1.274852 1.216304 1.157755 1.099206 1.040657 0.982108).toBits)
...
#eval IO.println ("check_strut_resists_lean " ++ toString (check_strut_resists_lean 0.326731 0.268182 0.209633 1.751084 1.692536 1.633987 1.575438 1.516889 1.458340 1.399792))
#eval IO.println ("check_strut_resists_lean " ++ toString (check_strut_resists_lean 1.595539 1.536990 1.478441 1.419892 1.361344 1.302795 1.244246 1.185697 1.127148 1.068600))
#eval IO.println ("check_strut_resists_lean " ++ toString (check_strut_resists_lean 1.264347 1.205798 1.147249 1.088700 1.030152 0.971603 0.913054 0.854505 0.795956 0.737408))
...
#eval IO.println ("sunDir " ++ toString ((sunDir 1.740579 1.682030).map Float.toBits))
#eval IO.println ("sunDir " ++ toString ((sunDir 1.409387 1.350838).map Float.toBits))
#eval IO.println ("sunDir " ++ toString ((sunDir 1.078195 1.019646).map Float.toBits))
...
#eval IO.println ("check_sunDir_rot " ++ toString (check_sunDir_rot 1.554427 1.495878 1.437329))
#eval IO.println ("check_sunDir_rot " ++ toString (check_sunDir_rot 1.223235 1.164686 1.106137))
#eval IO.println ("check_sunDir_rot " ++ toString (check_sunDir_rot 0.892043 0.833494 0.774945))
...
#eval IO.println ("sunInDish " ++ toString ((sunInDish 1.368275 1.309726 1.251177 1.192628).map Float.toBits))
#eval IO.println ("sunInDish " ++ toString ((sunInDish 1.037083 0.978534 0.919985 0.861436).map Float.toBits))
#eval IO.println ("sunInDish " ++ toString ((sunInDish 0.705891 0.647342 0.588793 0.530244).map Float.toBits))
...
#eval IO.println ("check_sunInDish_equivariant " ++ toString (check_sunInDish_equivariant 1.182123 1.123574 1.065025 1.006476 0.947928))
#eval IO.println ("check_sunInDish_equivariant " ++ toString (check_sunInDish_equivariant 0.850931 0.792382 0.733833 0.675284 0.616736))
#eval IO.println ("check_sunInDish_equivariant " ++ toString (check_sunInDish_equivariant 0.519739 0.461190 0.402641 0.344092 0.285544))
...
#eval IO.println ("sunReachableS " ++ toString (sunReachableS 0.809819 0.751270).toBits)
#eval IO.println ("sunReachableS " ++ toString (sunReachableS 0.478627 0.420078).toBits)
#eval IO.println ("sunReachableS " ++ toString (sunReachableS 1.747435 1.688886).toBits)
...
#eval IO.println ("check_sunReachableS_mem " ++ toString (check_sunReachableS_mem 0.623667 0.565118))
#eval IO.println ("check_sunReachableS_mem " ++ toString (check_sunReachableS_mem 0.292475 0.233926))
#eval IO.println ("check_sunReachableS_mem " ++ toString (check_sunReachableS_mem 1.561283 1.502734))
...
#eval IO.println ("check_sunReachableS_slope " ++ toString (check_sunReachableS_slope 0.437515 0.378966 0.320417))
#eval IO.println ("check_sunReachableS_slope " ++ toString (check_sunReachableS_slope 1.706323 1.647774 1.589225))
#eval IO.println ("check_sunReachableS_slope " ++ toString (check_sunReachableS_slope 1.375131 1.316582 1.258033))
...
#eval IO.println ("swingFocus " ++ toString ((swingFocus 0.251363 1.792814 1.734265 1.675716 1.617168).map Float.toBits))
#eval IO.println ("swingFocus " ++ toString ((swingFocus 1.520171 1.461622 1.403073 1.344524 1.285976).map Float.toBits))
#eval IO.println ("swingFocus " ++ toString ((swingFocus 1.188979 1.130430 1.071881 1.013332 0.954784).map Float.toBits))
...
#eval IO.println ("check_swingFocus_circle " ++ toString (check_swingFocus_circle 1.665211 1.606662 1.548113 1.489564 1.431016))
#eval IO.println ("check_swingFocus_circle " ++ toString (check_swingFocus_circle 1.334019 1.275470 1.216921 1.158372 1.099824))
#eval IO.println ("check_swingFocus_circle " ++ toString (check_swingFocus_circle 1.002827 0.944278 0.885729 0.827180 0.768632))

def swingNormal (t : Float) : Array Float :=
  #[(-(Float.sin t)), (Float.cos t)]

#eval IO.println ("swingNormal " ++ toString ((swingNormal 1.479059).map Float.toBits))
#eval IO.println ("swingNormal " ++ toString ((swingNormal 1.147867).map Float.toBits))
#eval IO.println ("swingNormal " ++ toString ((swingNormal 0.816675).map Float.toBits))

def check_swingNormal_unit (t : Float) : Bool :=
  (feq (((-(Float.sin t)) ^ 2) + ((Float.cos t) ^ 2)) (1 : Float))

#eval IO.println ("check_swingNormal_unit " ++ toString (check_swingNormal_unit 1.292907))
#eval IO.println ("check_swingNormal_unit " ++ toString (check_swingNormal_unit 0.961715))
#eval IO.println ("check_swingNormal_unit " ++ toString (check_swingNormal_unit 0.630523))
...
#eval IO.println ("swingOfLength " ++ toString (swingOfLength 1.106755 1.048206 0.989657 0.931108 0.872560 0.814011).toBits)
#eval IO.println ("swingOfLength " ++ toString (swingOfLength 0.775563 0.717014 0.658465 0.599916 0.541368 0.482819).toBits)
#eval IO.println ("swingOfLength " ++ toString (swingOfLength 0.444371 0.385822 0.327273 0.268724 0.210176 1.751627).toBits)
...
#eval IO.println ("swingTwist " ++ toString ((swingTwist 0.920603 0.862054).map Float.toBits))
#eval IO.println ("swingTwist " ++ toString ((swingTwist 0.589411 0.530862).map Float.toBits))
#eval IO.println ("swingTwist " ++ toString ((swingTwist 0.258219 1.799670).map Float.toBits))

def swingVertex (P_1 : Float) (P_2 : Float) (f : Float) (t : Float) : Array Float :=
  #[(P_1 + (f * (Float.sin t))), (P_2 - (f * (Float.cos t)))]

#eval IO.println ("swingVertex " ++ toString ((swingVertex 0.734451 0.675902 0.617353 0.558804).map Float.toBits))
#eval IO.println ("swingVertex " ++ toString ((swingVertex 0.403259 0.344710 0.286161 0.227612).map Float.toBits))
#eval IO.println ("swingVertex " ++ toString ((swingVertex 1.672067 1.613518 1.554969 1.496420).map Float.toBits))

def swingVertexAt (P_1 : Float) (P_2 : Float) (d : Float) (t : Float) : Array Float :=
  #[(P_1 + (d * (Float.sin t))), (P_2 - (d * (Float.cos t)))]

#eval IO.println ("swingVertexAt " ++ toString ((swingVertexAt 0.548299 0.489750 0.431201 0.372652).map Float.toBits))
#eval IO.println ("swingVertexAt " ++ toString ((swingVertexAt 0.217107 1.758558 1.700009 1.641460).map Float.toBits))
#eval IO.println ("swingVertexAt " ++ toString ((swingVertexAt 1.485915 1.427366 1.368817 1.310268).map Float.toBits))

def check_swing_focusCircle (P_1 : Float) (P_2 : Float) (f : Float) (t : Float) : Bool :=
  (feq ((((P_1 + (f * (Float.sin t))) - P_1) ^ 2) + (((P_2 - (f * (Float.cos t))) - P_2) ^ 2)) (f ^ 2))

#eval IO.println ("check_swing_focusCircle " ++ toString (check_swing_focusCircle 0.362147 0.303598 0.245049 1.786500))
#eval IO.println ("check_swing_focusCircle " ++ toString (check_swing_focusCircle 1.630955 1.572406 1.513857 1.455308))
#eval IO.println ("check_swing_focusCircle " ++ toString (check_swing_focusCircle 1.299763 1.241214 1.182665 1.124116))
...
#eval IO.println ("check_swing_lift " ++ toString (check_swing_lift 1.775995 1.717446 1.658897 1.600348 1.541800))
#eval IO.println ("check_swing_lift " ++ toString (check_swing_lift 1.444803 1.386254 1.327705 1.269156 1.210608))
#eval IO.println ("check_swing_lift " ++ toString (check_swing_lift 1.113611 1.055062 0.996513 0.937964 0.879416))
...
#eval IO.println ("swungPt " ++ toString ((swungPt 1.589843 1.531294 1.472745).map Float.toBits))
#eval IO.println ("swungPt " ++ toString ((swungPt 1.258651 1.200102 1.141553).map Float.toBits))
#eval IO.println ("swungPt " ++ toString ((swungPt 0.927459 0.868910 0.810361).map Float.toBits))
...
#eval IO.println ("check_tanh_abs_lt_one " ++ toString (check_tanh_abs_lt_one 1.217539))
#eval IO.println ("check_tanh_abs_lt_one " ++ toString (check_tanh_abs_lt_one 0.886347))
#eval IO.println ("check_tanh_abs_lt_one " ++ toString (check_tanh_abs_lt_one 0.555155))
...
#eval IO.println ("check_tension_le_of_holds " ++ toString (check_tension_le_of_holds 1.031387 0.972838 0.914289 0.855740 0.797192))
#eval IO.println ("check_tension_le_of_holds " ++ toString (check_tension_le_of_holds 0.700195 0.641646 0.583097 0.524548 0.466000))
#eval IO.println ("check_tension_le_of_holds " ++ toString (check_tension_le_of_holds 0.369003 0.310454 0.251905 1.793356 1.734808))
...
#eval IO.println ("tilt " ++ toString ((tilt 0.845235 0.786686 0.728137 0.669588 0.611040).map Float.toBits))
#eval IO.println ("tilt " ++ toString ((tilt 0.514043 0.455494 0.396945 0.338396 0.279848).map Float.toBits))
#eval IO.println ("tilt " ++ toString ((tilt 1.782851 1.724302 1.665753 1.607204 1.548656).map Float.toBits))

def tiltOfMismatch (e : Float) : Float :=
  (e / ((2 : Float) * (0.8 : Float)))

#eval IO.println ("tiltOfMismatch " ++ toString (tiltOfMismatch 0.659083).toBits)
#eval IO.println ("tiltOfMismatch " ++ toString (tiltOfMismatch 0.327891).toBits)
#eval IO.println ("tiltOfMismatch " ++ toString (tiltOfMismatch 1.596699).toBits)
...
#eval IO.println ("traceConic " ++ toString ((traceConic 0.472931 0.414382 0.355833 0.297284 0.238736 1.780187 1.721638 1.663089 1.604540).map Float.toBits))
#eval IO.println ("traceConic " ++ toString ((traceConic 1.741739 1.683190 1.624641 1.566092 1.507544 1.448995 1.390446 1.331897 1.273348).map Float.toBits))
#eval IO.println ("traceConic " ++ toString ((traceConic 1.410547 1.351998 1.293449 1.234900 1.176352 1.117803 1.059254 1.000705 0.942156).map Float.toBits))
...
#eval IO.println ("traceFacet " ++ toString ((traceFacet 0.286779 0.228230 1.769681 1.711132 1.652584 1.594035 1.535486 1.476937 1.418388 1.359840).map Float.toBits))
#eval IO.println ("traceFacet " ++ toString ((traceFacet 1.555587 1.497038 1.438489 1.379940 1.321392 1.262843 1.204294 1.145745 1.087196 1.028648).map Float.toBits))
#eval IO.println ("traceFacet " ++ toString ((traceFacet 1.224395 1.165846 1.107297 1.048748 0.990200 0.931651 0.873102 0.814553 0.756004 0.697456).map Float.toBits))
...
#eval IO.println ("traceRay " ++ toString ((traceRay 1.514475 1.455926 1.397377 1.338828 1.280280 1.221731 1.163182 1.104633 1.046084 0.987536 0.928987 0.870438).map Float.toBits))
#eval IO.println ("traceRay " ++ toString ((traceRay 1.183283 1.124734 1.066185 1.007636 0.949088 0.890539 0.831990 0.773441 0.714892 0.656344 0.597795 0.539246).map Float.toBits))
#eval IO.println ("traceRay " ++ toString ((traceRay 0.852091 0.793542 0.734993 0.676444 0.617896 0.559347 0.500798 0.442249 0.383700 0.325152 0.266603 0.208054).map Float.toBits))
...
#eval IO.println ("traceRayErr " ++ toString ((traceRayErr 1.328323 1.269774 1.211225 1.152676 1.094128 1.035579 0.977030 0.918481 0.859932 0.801384 0.742835 0.684286 0.625737 0.567188 0.508640 0.450091 0.391542 0.332993).map Float.toBits))
#eval IO.println ("traceRayErr " ++ toString ((traceRayErr 0.997131 0.938582 0.880033 0.821484 0.762936 0.704387 0.645838 0.587289 0.528740 0.470192 0.411643 0.353094 0.294545 0.235996 1.777448 1.718899 1.660350 1.601801).map Float.toBits))
#eval IO.println ("traceRayErr " ++ toString ((traceRayErr 0.665939 0.607390 0.548841 0.490292 0.431744 0.373195 0.314646 0.256097 1.797548 1.739000 1.680451 1.621902 1.563353 1.504804 1.446256 1.387707 1.329158 1.270609).map Float.toBits))
...
#eval IO.println ("traceRayK " ++ toString ((traceRayK 1.142171 1.083622 1.025073 0.966524 0.907976 0.849427 0.790878 0.732329 0.673780 0.615232 0.556683 0.498134 0.439585).map Float.toBits))
#eval IO.println ("traceRayK " ++ toString ((traceRayK 0.810979 0.752430 0.693881 0.635332 0.576784 0.518235 0.459686 0.401137 0.342588 0.284040 0.225491 1.766942 1.708393).map Float.toBits))
#eval IO.println ("traceRayK " ++ toString ((traceRayK 0.479787 0.421238 0.362689 0.304140 0.245592 1.787043 1.728494 1.669945 1.611396 1.552848 1.494299 1.435750 1.377201).map Float.toBits))
...
#eval IO.println ("traceRayKErr " ++ toString ((traceRayKErr 0.956019 0.897470 0.838921 0.780372 0.721824 0.663275 0.604726 0.546177 0.487628 0.429080 0.370531 0.311982 0.253433 1.794884 1.736336 1.677787 1.619238 1.560689 1.502140).map Float.toBits))
#eval IO.println ("traceRayKErr " ++ toString ((traceRayKErr 0.624827 0.566278 0.507729 0.449180 0.390632 0.332083 0.273534 0.214985 1.756436 1.697888 1.639339 1.580790 1.522241 1.463692 1.405144 1.346595 1.288046 1.229497 1.170948).map Float.toBits))
#eval IO.println ("traceRayKErr " ++ toString ((traceRayKErr 0.293635 0.235086 1.776537 1.717988 1.659440 1.600891 1.542342 1.483793 1.425244 1.366696 1.308147 1.249598 1.191049 1.132500 1.073952 1.015403 0.956854 0.898305 0.839756).map Float.toBits))
...
#eval IO.println ("traceSphere " ++ toString ((traceSphere 0.769867 0.711318 0.652769 0.594220 0.535672 0.477123 0.418574 0.360025).map Float.toBits))
#eval IO.println ("traceSphere " ++ toString ((traceSphere 0.438675 0.380126 0.321577 0.263028 0.204480 1.745931 1.687382 1.628833).map Float.toBits))
#eval IO.println ("traceSphere " ++ toString ((traceSphere 1.707483 1.648934 1.590385 1.531836 1.473288 1.414739 1.356190 1.297641).map Float.toBits))

def check_trackerBudget_iff (f : Float) (eps : Float) (h : Float) : Bool :=
  let v5 := (Float.tan eps)
  (!((0 : Float) < f) || (((f * v5) <= h) == (v5 <= (h / f))))

#eval IO.println ("check_trackerBudget_iff " ++ toString (check_trackerBudget_iff 0.583715 0.525166 0.466617))
#eval IO.println ("check_trackerBudget_iff " ++ toString (check_trackerBudget_iff 0.252523 1.793974 1.735425))
#eval IO.println ("check_trackerBudget_iff " ++ toString (check_trackerBudget_iff 1.521331 1.462782 1.404233))

def check_tracker_margin_hashemi (eps : Float) : Bool :=
  let v2 := (Float.tan eps)
  ((((1 : Float) * v2) <= (0.03 : Float)) == (v2 <= (0.03 : Float)))

#eval IO.println ("check_tracker_margin_hashemi " ++ toString (check_tracker_margin_hashemi 0.397563))
#eval IO.println ("check_tracker_margin_hashemi " ++ toString (check_tracker_margin_hashemi 1.666371))
#eval IO.println ("check_tracker_margin_hashemi " ++ toString (check_tracker_margin_hashemi 1.335179))

def check_tracking_power_tiny (W : Float) (rcm : Float) (omega : Float) (t : Float) : Bool :=
  (!((0 : Float) <= W) || (!(W <= (1000 : Float)) || (!((0 : Float) <= rcm) || (!(rcm <= (1 : Float)) || (!((0 : Float) <= omega) || (!(omega <= (0.000073 : Float)) || (((((W * rcm) * (Float.sin t)) * omega) <= (0.073 : Float)) && ((0.073 : Float) < ((0.015 : Float) * (5 : Float))))))))))

#eval IO.println ("check_tracking_power_tiny " ++ toString (check_tracking_power_tiny 0.211411 1.752862 1.694313 1.635764))
#eval IO.println ("check_tracking_power_tiny " ++ toString (check_tracking_power_tiny 1.480219 1.421670 1.363121 1.304572))
#eval IO.println ("check_tracking_power_tiny " ++ toString (check_tracking_power_tiny 1.149027 1.090478 1.031929 0.973380))
...
#eval IO.println ("unit3 " ++ toString ((unit3 1.625259 1.566710 1.508161).map Float.toBits))
#eval IO.println ("unit3 " ++ toString ((unit3 1.294067 1.235518 1.176969).map Float.toBits))
#eval IO.println ("unit3 " ++ toString ((unit3 0.962875 0.904326 0.845777).map Float.toBits))
...
#eval IO.println ("wBearX " ++ toString ((wBearX 1.439107 1.380558 1.322009 1.263460 1.204912 1.146363).map Float.toBits))
#eval IO.println ("wBearX " ++ toString ((wBearX 1.107915 1.049366 0.990817 0.932268 0.873720 0.815171).map Float.toBits))
#eval IO.println ("wBearX " ++ toString ((wBearX 0.776723 0.718174 0.659625 0.601076 0.542528 0.483979).map Float.toBits))
...
#eval IO.println ("wBearY " ++ toString ((wBearY 1.252955 1.194406 1.135857 1.077308 1.018760 0.960211).map Float.toBits))
#eval IO.println ("wBearY " ++ toString ((wBearY 0.921763 0.863214 0.804665 0.746116 0.687568 0.629019).map Float.toBits))
#eval IO.println ("wBearY " ++ toString ((wBearY 0.590571 0.532022 0.473473 0.414924 0.356376 0.297827).map Float.toBits))
...
#eval IO.println ("wDrive " ++ toString ((wDrive 1.066803 1.008254 0.949705 0.891156 0.832608 0.774059 0.715510 0.656961 0.598412 0.539864 0.481315 0.422766 0.364217).map Float.toBits))
#eval IO.println ("wDrive " ++ toString ((wDrive 0.735611 0.677062 0.618513 0.559964 0.501416 0.442867 0.384318 0.325769 0.267220 0.208672 1.750123 1.691574 1.633025).map Float.toBits))
#eval IO.println ("wDrive " ++ toString ((wDrive 0.404419 0.345870 0.287321 0.228772 1.770224 1.711675 1.653126 1.594577 1.536028 1.477480 1.418931 1.360382 1.301833).map Float.toBits))
...
#eval IO.println ("wRollN " ++ toString ((wRollN 0.880651 0.822102 0.763553 0.705004 0.646456 0.587907 0.529358 0.470809 0.412260 0.353712 0.295163 0.236614).map Float.toBits))
#eval IO.println ("wRollN " ++ toString ((wRollN 0.549459 0.490910 0.432361 0.373812 0.315264 0.256715 1.798166 1.739617 1.681068 1.622520 1.563971 1.505422).map Float.toBits))
#eval IO.println ("wRollN " ++ toString ((wRollN 0.218267 1.759718 1.701169 1.642620 1.584072 1.525523 1.466974 1.408425 1.349876 1.291328 1.232779 1.174230).map Float.toBits))
...
#eval IO.println ("wRollNr " ++ toString ((wRollNr 0.694499 0.635950 0.577401 0.518852 0.460304 0.401755 0.343206 0.284657 0.226108 1.767560 1.709011 1.650462).map Float.toBits))
#eval IO.println ("wRollNr " ++ toString ((wRollNr 0.363307 0.304758 0.246209 1.787660 1.729112 1.670563 1.612014 1.553465 1.494916 1.436368 1.377819 1.319270).map Float.toBits))
#eval IO.println ("wRollNr " ++ toString ((wRollNr 1.632115 1.573566 1.515017 1.456468 1.397920 1.339371 1.280822 1.222273 1.163724 1.105176 1.046627 0.988078).map Float.toBits))
...
#eval IO.println ("wRollP " ++ toString ((wRollP 0.508347 0.449798 0.391249 0.332700 0.274152 0.215603 1.757054 1.698505 1.639956 1.581408 1.522859 1.464310).map Float.toBits))
#eval IO.println ("wRollP " ++ toString ((wRollP 1.777155 1.718606 1.660057 1.601508 1.542960 1.484411 1.425862 1.367313 1.308764 1.250216 1.191667 1.133118).map Float.toBits))
#eval IO.println ("wRollP " ++ toString ((wRollP 1.445963 1.387414 1.328865 1.270316 1.211768 1.153219 1.094670 1.036121 0.977572 0.919024 0.860475 0.801926).map Float.toBits))
...
#eval IO.println ("wRollPr " ++ toString ((wRollPr 0.322195 0.263646 0.205097 1.746548 1.688000 1.629451 1.570902 1.512353 1.453804 1.395256 1.336707 1.278158).map Float.toBits))
#eval IO.println ("wRollPr " ++ toString ((wRollPr 1.591003 1.532454 1.473905 1.415356 1.356808 1.298259 1.239710 1.181161 1.122612 1.064064 1.005515 0.946966).map Float.toBits))
#eval IO.println ("wRollPr " ++ toString ((wRollPr 1.259811 1.201262 1.142713 1.084164 1.025616 0.967067 0.908518 0.849969 0.791420 0.732872 0.674323 0.615774).map Float.toBits))
...
#eval IO.println ("wStop " ++ toString ((wStop 1.736043 1.677494 1.618945 1.560396 1.501848 1.443299).map Float.toBits))
#eval IO.println ("wStop " ++ toString ((wStop 1.404851 1.346302 1.287753 1.229204 1.170656 1.112107).map Float.toBits))
#eval IO.println ("wStop " ++ toString ((wStop 1.073659 1.015110 0.956561 0.898012 0.839464 0.780915).map Float.toBits))
...
#eval IO.println ("wireLen " ++ toString (wireLen 1.363739 1.305190 1.246641 1.188092 1.129544).toBits)
#eval IO.println ("wireLen " ++ toString (wireLen 1.032547 0.973998 0.915449 0.856900 0.798352).toBits)
#eval IO.println ("wireLen " ++ toString (wireLen 0.701355 0.642806 0.584257 0.525708 0.467160).toBits)

def wireLever (P_1 : Float) (P_2 : Float) (B_1 : Float) (B_2 : Float) : Float :=
  (((P_1 * B_2) - (P_2 * B_1)) / (Float.sqrt (((B_1 - P_1) ^ 2) + ((B_2 - P_2) ^ 2))))

#eval IO.println ("wireLever " ++ toString (wireLever 1.177587 1.119038 1.060489 1.001940).toBits)
#eval IO.println ("wireLever " ++ toString (wireLever 0.846395 0.787846 0.729297 0.670748).toBits)
#eval IO.println ("wireLever " ++ toString (wireLever 0.515203 0.456654 0.398105 0.339556).toBits)
...
#eval IO.println ("check_wireLever_edge_formula " ++ toString (check_wireLever_edge_formula 0.991435 0.932886 0.874337 0.815788 0.757240))
#eval IO.println ("check_wireLever_edge_formula " ++ toString (check_wireLever_edge_formula 0.660243 0.601694 0.543145 0.484596 0.426048))
#eval IO.println ("check_wireLever_edge_formula " ++ toString (check_wireLever_edge_formula 0.329051 0.270502 0.211953 1.753404 1.694856))
...
#eval IO.println ("check_wireLever_pos_iff " ++ toString (check_wireLever_pos_iff 0.805283 0.746734 0.688185 0.629636))
#eval IO.println ("check_wireLever_pos_iff " ++ toString (check_wireLever_pos_iff 0.474091 0.415542 0.356993 0.298444))
#eval IO.println ("check_wireLever_pos_iff " ++ toString (check_wireLever_pos_iff 1.742899 1.684350 1.625801 1.567252))
...
#eval IO.println ("check_wireLever_rest " ++ toString (check_wireLever_rest 0.619131 0.560582 0.502033 0.443484))
#eval IO.println ("check_wireLever_rest " ++ toString (check_wireLever_rest 0.287939 0.229390 1.770841 1.712292))
#eval IO.println ("check_wireLever_rest " ++ toString (check_wireLever_rest 1.556747 1.498198 1.439649 1.381100))
...
#eval IO.println ("wireTension " ++ toString (wireTension 1.660675 1.602126 1.543577 1.485028).toBits)
#eval IO.println ("wireTension " ++ toString (wireTension 1.329483 1.270934 1.212385 1.153836).toBits)
#eval IO.println ("wireTension " ++ toString (wireTension 0.998291 0.939742 0.881193 0.822644).toBits)
...
#eval IO.println ("check_wire_recip_swing " ++ toString (check_wire_recip_swing 1.474523 1.415974 1.357425 1.298876 1.240328 1.181779 1.123230 1.064681))
#eval IO.println ("check_wire_recip_swing " ++ toString (check_wire_recip_swing 1.143331 1.084782 1.026233 0.967684 0.909136 0.850587 0.792038 0.733489))
#eval IO.println ("check_wire_recip_swing " ++ toString (check_wire_recip_swing 0.812139 0.753590 0.695041 0.636492 0.577944 0.519395 0.460846 0.402297))
...
#eval IO.println ("check_wire_taut_iff " ++ toString (check_wire_taut_iff 1.102219 1.043670 0.985121 0.926572))
#eval IO.println ("check_wire_taut_iff " ++ toString (check_wire_taut_iff 0.771027 0.712478 0.653929 0.595380))
#eval IO.println ("check_wire_taut_iff " ++ toString (check_wire_taut_iff 0.439835 0.381286 0.322737 0.264188))

def wrapRad (d : Float) : Float :=
  let v3 := ((2 : Float) * (3.141592653589793 : Float))
  (d - (v3 * (Float.floor ((d + (3.141592653589793 : Float)) / v3))))

#eval IO.println ("wrapRad " ++ toString (wrapRad 0.916067).toBits)
#eval IO.println ("wrapRad " ++ toString (wrapRad 0.584875).toBits)
#eval IO.println ("wrapRad " ++ toString (wrapRad 0.253683).toBits)
...
#eval IO.println ("check_wrapRad_mem " ++ toString (check_wrapRad_mem 0.729915))
#eval IO.println ("check_wrapRad_mem " ++ toString (check_wrapRad_mem 0.398723))
#eval IO.println ("check_wrapRad_mem " ++ toString (check_wrapRad_mem 1.667531))
...
#eval IO.println ("wrenchAt " ++ toString ((wrenchAt 0.543763 0.485214 0.426665 0.368116 0.309568 0.251019).map Float.toBits))
#eval IO.println ("wrenchAt " ++ toString ((wrenchAt 0.212571 1.754022 1.695473 1.636924 1.578376 1.519827).map Float.toBits))
#eval IO.println ("wrenchAt " ++ toString ((wrenchAt 1.481379 1.422830 1.364281 1.305732 1.247184 1.188635).map Float.toBits))
...
#eval IO.println ("check_yaw_lifts_nothing " ++ toString (check_yaw_lifts_nothing 1.585307 1.526758 1.468209))
#eval IO.println ("check_yaw_lifts_nothing " ++ toString (check_yaw_lifts_nothing 1.254115 1.195566 1.137017))
#eval IO.println ("check_yaw_lifts_nothing " ++ toString (check_yaw_lifts_nothing 0.922923 0.864374 0.805825))
