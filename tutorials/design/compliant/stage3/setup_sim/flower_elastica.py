...
json.dump(dict(frames=frames, log=log, F=F.tolist(), stem_top=S_REC.tolist(), t_setup=T_S, t_cal=T_C, t_day=A.t_day, wind=A.wind, ident=ident, n_rods=len(rods)), open(os.path.join(OUT, A.tag + "_anim.json"), "w"), separators=(",", ":"))
