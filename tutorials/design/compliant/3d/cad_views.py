...
CONFIG = {
    ...
    "tw_equinox_noon": dict(title="The crown sized for wind, equinox noon: a hexapod of six steel struts from the receptacle ring to the back ring, the calyx under the membrane, the stem a 215 mm steel column",
                            iso=(-1.0, -1.0, 0.55), bounds_exclude=("sun",), context=("deck", "light pipe"),
                            detail=(1600, 4800, -1600, 1600, 5000, 7800), detail_label="detail: the receptacle ring, the six legs, the back and inner rings, the twigs"),
    "tw_winter_noon": dict(title="Winter (day 35) noon on the env's law: the head 3.5 m north and 3 m up on the orbit sphere, beta 16 deg, the legs 1.7-4.0 m", iso=(-1.0, -1.0, 0.55), bounds_exclude=("sun",), context=("deck", "light pipe")),
    "tw_sweep": dict(title="Where the hexapod carries the head on the env's law (orbit sphere, axis the bisector, beta within 36 deg): 9, 12, 15 h equinox, winter and summer noon", iso=(-1.0, -1.0, 0.55), bounds_exclude=("sun",), context=("deck", "light pipe")),
    "tr_equinox_noon": dict(title="The flower proper, equinox noon: one stem, a crown of branches carrying the exact spherical membrane, F on the light pipe",
                            iso=(-1.0, -1.0, 0.55), bounds_exclude=("sun",), context=("deck", "light pipe"),
    ...
    "tr_summer_noon": dict(title="Summer noon, el 83: the head 0.9 m over the deck beside the pipe, looking up", iso=(-1.0, -1.0, 0.55), bounds_exclude=("sun",), context=("deck", "light pipe")),
