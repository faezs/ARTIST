...
PYTHONPATH=/Users/faezs/ARTIST $PY -u tandoor_designer.py $CK --sites 0.5 --gens 4 --cand 512 --top 64 --seasoned 2 --over-cap 0.5 --budget 300000 --out $W/design_pop_4x6_300k_v2.json > $W/designer_4x6_300k_v2.log 2>&1
